...
module Godot
  class UndoRedo < Godot::Object
    ...
    def create_action(name : String, merge_mode : MergeMode | Int = 0, backward_undo_ops : Bool = false) : Void
      ...
      godot_ptrcall_void(@@mb_create_action, @pointer, args.to_unsafe.as(Void**))
    ensure
    ...
    def commit_action(execute : Bool = true) : Void
      ...
      godot_ptrcall_void(@@mb_commit_action, @pointer, args.to_unsafe.as(Void**))
    end
    ...
    def is_committing_action() : Bool
      ...
      godot_ptrcall_bool(@@mb_is_committing_action, @pointer, Pointer(Pointer(Void)).null)
    end
    # Predicate alias for `is_committing_action`
    def is_committing_action?() : Bool
      is_committing_action()
    end
    # Predicate alias for `is_committing_action`
    def committing_action?() : Bool
      is_committing_action()
    end
    ...
    def add_do_method(callable : Pointer(Void)) : Void
      ...
      arg_0 = pointerof(val_0).as(Void*)
      args = StaticArray[arg_0]
      godot_ptrcall_void(@@mb_add_do_method, @pointer, args.to_unsafe.as(Void**))
    end
    ...
    def add_undo_method(callable : Pointer(Void)) : Void
      ...
      arg_0 = pointerof(val_0).as(Void*)
      args = StaticArray[arg_0]
      godot_ptrcall_void(@@mb_add_undo_method, @pointer, args.to_unsafe.as(Void**))
    end
    ...
    def add_do_property(object : Godot::Object, property : String, value : Pointer(Void)) : Void
      ...
      arg_2 = pointerof(val_2).as(Void*)
      args = StaticArray[arg_0, arg_1, arg_2]
      godot_ptrcall_void(@@mb_add_do_property, @pointer, args.to_unsafe.as(Void**))
    ensure
    ...
    def add_undo_property(object : Godot::Object, property : String, value : Pointer(Void)) : Void
      ...
      arg_2 = pointerof(val_2).as(Void*)
      args = StaticArray[arg_0, arg_1, arg_2]
      godot_ptrcall_void(@@mb_add_undo_property, @pointer, args.to_unsafe.as(Void**))
    ensure
      Bridge.free_string_name(sn_1)
    end
    ...
    def add_do_reference(object : Godot::Object) : Void
      ...
      arg_0 = pointerof(arg_ptr_0).as(Void*)
      args = StaticArray[arg_0]
      godot_ptrcall_void(@@mb_add_do_reference, @pointer, args.to_unsafe.as(Void**))
    end
    ...
    def add_undo_reference(object : Godot::Object) : Void
      ...
      arg_0 = pointerof(arg_ptr_0).as(Void*)
      args = StaticArray[arg_0]
      godot_ptrcall_void(@@mb_add_undo_reference, @pointer, args.to_unsafe.as(Void**))
    end
    ...
    def start_force_keep_in_merge_ends() : Void
      ...
      godot_ptrcall_void(@@mb_start_force_keep_in_merge_ends, @pointer, Pointer(Pointer(Void)).null)
    end
    ...
    def end_force_keep_in_merge_ends() : Void
      ...
      godot_ptrcall_void(@@mb_end_force_keep_in_merge_ends, @pointer, Pointer(Pointer(Void)).null)
    end
    ...
    def get_history_count() : Int64
      ...
      godot_ptrcall_int(@@mb_get_history_count, @pointer, Pointer(Pointer(Void)).null)
    end
    ...
    def get_current_action() : Int64
      ...
      godot_ptrcall_int(@@mb_get_current_action, @pointer, Pointer(Pointer(Void)).null)
    end
    ...
    def has_undo() : Bool
      ...
      godot_ptrcall_bool(@@mb_has_undo, @pointer, Pointer(Pointer(Void)).null)
    end
    # Predicate alias for `has_undo`
    def has_undo?() : Bool
      has_undo()
    end
    ...
    def has_redo() : Bool
      ...
      godot_ptrcall_bool(@@mb_has_redo, @pointer, Pointer(Pointer(Void)).null)
    end
    # Predicate alias for `has_redo`
    def has_redo?() : Bool
      has_redo()
    end
    ...
    def get_version() : Int64
      ...
      godot_ptrcall_int(@@mb_get_version, @pointer, Pointer(Pointer(Void)).null)
    end
    ...
    def set_max_steps(max_steps : Int64) : Void
      ...
      val_0 = max_steps.to_i64
      arg_0 = pointerof(val_0).as(Void*)
      args = StaticArray[arg_0]
      godot_ptrcall_void(@@mb_set_max_steps, @pointer, args.to_unsafe.as(Void**))
    end
    ...
    def get_max_steps() : Int64
      ...
      godot_ptrcall_int(@@mb_get_max_steps, @pointer, Pointer(Pointer(Void)).null)
    end
    @@mb_redo : Void* = Pointer(Void).null
    def redo_val() : Bool
      godot_bind(@@mb_redo, "UndoRedo", "redo", 2240911060_i64)
      godot_ptrcall_bool(@@mb_redo, @pointer, Pointer(Pointer(Void)).null)
    end
    # Predicate alias for `redo_val`
    def redo_val?() : Bool
      redo_val()
    end
    ...
    def undo() : Bool
      ...
      godot_ptrcall_bool(@@mb_undo, @pointer, Pointer(Pointer(Void)).null)
    end
    # Predicate alias for `undo`
    def undo?() : Bool
      undo()
    end
  ...
  class UniformSetCacheRD < Godot::Object
    ...
    def self.get_cache(shader : Int64, set : Int64, uniforms : Pointer(Void)) : Int64
      ...
      arg_2 = pointerof(val_2).as(Void*)
      args = StaticArray[arg_0, arg_1, arg_2]
      godot_ptrcall_int(@@mb_get_cache, Pointer(Void).null, args.to_unsafe.as(Void**))
    end
  ...
  class VehicleBody3D < Godot::RigidBody3D
    ...
    def set_engine_force(engine_force : Float64) : Void
      ...
      val_0 = engine_force.to_f64
      arg_0 = pointerof(val_0).as(Void*)
      args = StaticArray[arg_0]
      godot_ptrcall_void(@@mb_set_engine_force, @pointer, args.to_unsafe.as(Void**))
    end
    ...
    def get_engine_force() : Float64
      ...
      godot_ptrcall_float(@@mb_get_engine_force, @pointer, Pointer(Pointer(Void)).null)
    end
    ...
    def set_brake(brake : Float64) : Void
      ...
      arg_0 = pointerof(val_0).as(Void*)
      args = StaticArray[arg_0]
      godot_ptrcall_void(@@mb_set_brake, @pointer, args.to_unsafe.as(Void**))
    end
    @@mb_get_brake : Void* = Pointer(Void).null
    def get_brake() : Float64
      godot_bind(@@mb_get_brake, "VehicleBody3D", "get_brake", 1740695150_i64)
      godot_ptrcall_float(@@mb_get_brake, @pointer, Pointer(Pointer(Void)).null)
    end
    ...
    def set_steering(steering : Float64) : Void
      ...
      val_0 = steering.to_f64
      arg_0 = pointerof(val_0).as(Void*)
      args = StaticArray[arg_0]
      godot_ptrcall_void(@@mb_set_steering, @pointer, args.to_unsafe.as(Void**))
    end
    ...
    def get_steering() : Float64
      ...
      godot_ptrcall_float(@@mb_get_steering, @pointer, Pointer(Pointer(Void)).null)
    end
  ...
  class VehicleWheel3D < Godot::Node3D
    ...
    def get_radius() : Float64
      ...
      godot_ptrcall_float(@@mb_get_radius, @pointer, Pointer(Pointer(Void)).null)
    end
    ...
    def set_suspension_rest_length(length : Float64) : Void
      ...
      arg_0 = pointerof(val_0).as(Void*)
      args = StaticArray[arg_0]
      godot_ptrcall_void(@@mb_set_suspension_rest_length, @pointer, args.to_unsafe.as(Void**))
    end
    ...
    def get_suspension_rest_length() : Float64
      ...
      godot_ptrcall_float(@@mb_get_suspension_rest_length, @pointer, Pointer(Pointer(Void)).null)
    end
    ...
    def set_suspension_travel(length : Float64) : Void
      ...
      arg_0 = pointerof(val_0).as(Void*)
      args = StaticArray[arg_0]
      godot_ptrcall_void(@@mb_set_suspension_travel, @pointer, args.to_unsafe.as(Void**))
    end
    ...
    def get_suspension_travel() : Float64
      ...
      godot_ptrcall_float(@@mb_get_suspension_travel, @pointer, Pointer(Pointer(Void)).null)
    end
    ...
    def set_suspension_stiffness(length : Float64) : Void
      ...
      arg_0 = pointerof(val_0).as(Void*)
      args = StaticArray[arg_0]
      godot_ptrcall_void(@@mb_set_suspension_stiffness, @pointer, args.to_unsafe.as(Void**))
    end
    ...
    def get_suspension_stiffness() : Float64
      ...
      godot_ptrcall_float(@@mb_get_suspension_stiffness, @pointer, Pointer(Pointer(Void)).null)
    end
    ...
    def set_suspension_max_force(length : Float64) : Void
      ...
      arg_0 = pointerof(val_0).as(Void*)
      args = StaticArray[arg_0]
      godot_ptrcall_void(@@mb_set_suspension_max_force, @pointer, args.to_unsafe.as(Void**))
    end
    ...
    def get_suspension_max_force() : Float64
      ...
      godot_ptrcall_float(@@mb_get_suspension_max_force, @pointer, Pointer(Pointer(Void)).null)
    end
    ...
    def set_damping_compression(length : Float64) : Void
      ...
      arg_0 = pointerof(val_0).as(Void*)
      args = StaticArray[arg_0]
      godot_ptrcall_void(@@mb_set_damping_compression, @pointer, args.to_unsafe.as(Void**))
    end
    ...
    def get_damping_compression() : Float64
      ...
      godot_ptrcall_float(@@mb_get_damping_compression, @pointer, Pointer(Pointer(Void)).null)
    end
    ...
    def set_damping_relaxation(length : Float64) : Void
      ...
      arg_0 = pointerof(val_0).as(Void*)
      args = StaticArray[arg_0]
      godot_ptrcall_void(@@mb_set_damping_relaxation, @pointer, args.to_unsafe.as(Void**))
    end
    ...
    def get_damping_relaxation() : Float64
      ...
      godot_ptrcall_float(@@mb_get_damping_relaxation, @pointer, Pointer(Pointer(Void)).null)
    end
    ...
    def set_use_as_traction(enable : Bool) : Void
      ...
      arg_0 = pointerof(val_0).as(Void*)
      args = StaticArray[arg_0]
      godot_ptrcall_void(@@mb_set_use_as_traction, @pointer, args.to_unsafe.as(Void**))
    end
    ...
    def is_used_as_traction() : Bool
      ...
      godot_ptrcall_bool(@@mb_is_used_as_traction, @pointer, Pointer(Pointer(Void)).null)
    end
    # Predicate alias for `is_used_as_traction`
    def is_used_as_traction?() : Bool
      is_used_as_traction()
    end
    # Predicate alias for `is_used_as_traction`
    def used_as_traction?() : Bool
      is_used_as_traction()
    end
    ...
    def set_use_as_steering(enable : Bool) : Void
      ...
      arg_0 = pointerof(val_0).as(Void*)
      args = StaticArray[arg_0]
      godot_ptrcall_void(@@mb_set_use_as_steering, @pointer, args.to_unsafe.as(Void**))
    end
    ...
    def is_used_as_steering() : Bool
      ...
      godot_ptrcall_bool(@@mb_is_used_as_steering, @pointer, Pointer(Pointer(Void)).null)
    end
    # Predicate alias for `is_used_as_steering`
    def is_used_as_steering?() : Bool
      is_used_as_steering()
    end
    # Predicate alias for `is_used_as_steering`
    def used_as_steering?() : Bool
      is_used_as_steering()
    end
    ...
    def set_friction_slip(length : Float64) : Void
      ...
      arg_0 = pointerof(val_0).as(Void*)
      args = StaticArray[arg_0]
      godot_ptrcall_void(@@mb_set_friction_slip, @pointer, args.to_unsafe.as(Void**))
    end
    ...
    def get_friction_slip() : Float64
      ...
      godot_ptrcall_float(@@mb_get_friction_slip, @pointer, Pointer(Pointer(Void)).null)
    end
    ...
    def is_in_contact() : Bool
      ...
      godot_ptrcall_bool(@@mb_is_in_contact, @pointer, Pointer(Pointer(Void)).null)
    end
    # Predicate alias for `is_in_contact`
    def is_in_contact?() : Bool
      is_in_contact()
    end
    # Predicate alias for `is_in_contact`
    ...
    def get_contact_body() : Node3D
      ...
      godot_ptrcall_obj(@@mb_get_contact_body, @pointer, Pointer(Pointer(Void)).null, Node3D)
    end
    ...
    def get_contact_point() : Vector3
      ...
      godot_ptrcall_val(@@mb_get_contact_point, @pointer, Pointer(Pointer(Void)).null, Vector3)
    end
    ...
    def get_contact_normal() : Vector3
      ...
      godot_ptrcall_val(@@mb_get_contact_normal, @pointer, Pointer(Pointer(Void)).null, Vector3)
    end
    ...
    def set_roll_influence(roll_influence : Float64) : Void
      ...
      val_0 = roll_influence.to_f64
      arg_0 = pointerof(val_0).as(Void*)
      args = StaticArray[arg_0]
      godot_ptrcall_void(@@mb_set_roll_influence, @pointer, args.to_unsafe.as(Void**))
    end
    ...
    def get_roll_influence() : Float64
      ...
      godot_ptrcall_float(@@mb_get_roll_influence, @pointer, Pointer(Pointer(Void)).null)
    end
    ...
    def get_skidinfo() : Float64
      ...
      godot_ptrcall_float(@@mb_get_skidinfo, @pointer, Pointer(Pointer(Void)).null)
    end
    @@mb_get_rpm : Void* = Pointer(Void).null
    def get_rpm() : Float64
      godot_bind(@@mb_get_rpm, "VehicleWheel3D", "get_rpm", 1740695150_i64)
      godot_ptrcall_float(@@mb_get_rpm, @pointer, Pointer(Pointer(Void)).null)
    end
    @@mb_set_engine_force : Void* = Pointer(Void).null
    def set_engine_force(engine_force : Float64) : Void
  ...
  class VideoStream < Godot::Resource
    ...
    def set_file(file : String) : Void
      ...
      arg_0 = str_0
      args = StaticArray[arg_0]
      godot_ptrcall_void(@@mb_set_file, @pointer, args.to_unsafe.as(Void**))
    ensure
      Bridge.free_string(str_0)
    end
  ...
  class VideoStreamPlayback < Godot::Resource
    ...
    def mix_audio(num_frames : Int64, buffer : Pointer(Void), offset : Int64 = 0_i64) : Int64
      ...
      arg_2 = pointerof(val_2).as(Void*)
      args = StaticArray[arg_0, arg_1, arg_2]
      godot_ptrcall_int(@@mb_mix_audio, @pointer, args.to_unsafe.as(Void**))
    end
  end
  class VideoStreamPlayer < Godot::Control
    ...
    def set_stream(stream : VideoStream) : Void
      ...
      arg_0 = pointerof(arg_ptr_0).as(Void*)
      args = StaticArray[arg_0]
      godot_ptrcall_void(@@mb_set_stream, @pointer, args.to_unsafe.as(Void**))
    end
    ...
    def get_stream() : VideoStream
      ...
      godot_ptrcall_obj(@@mb_get_stream, @pointer, Pointer(Pointer(Void)).null, VideoStream)
    end
    @@mb_play : Void* = Pointer(Void).null
    def play() : Void
      godot_bind(@@mb_play, "VideoStreamPlayer", "play", 3218959716_i64)
      godot_ptrcall_void(@@mb_play, @pointer, Pointer(Pointer(Void)).null)
    end
    @@mb_stop : Void* = Pointer(Void).null
    def stop() : Void
      godot_bind(@@mb_stop, "VideoStreamPlayer", "stop", 3218959716_i64)
      godot_ptrcall_void(@@mb_stop, @pointer, Pointer(Pointer(Void)).null)
    end
    ...
    def set_paused(paused : Bool) : Void
      ...
      arg_0 = pointerof(val_0).as(Void*)
      args = StaticArray[arg_0]
      godot_ptrcall_void(@@mb_set_paused, @pointer, args.to_unsafe.as(Void**))
    end
    @@mb_is_paused : Void* = Pointer(Void).null
    def is_paused() : Bool
      godot_bind(@@mb_is_paused, "VideoStreamPlayer", "is_paused", 36873697_i64)
      godot_ptrcall_bool(@@mb_is_paused, @pointer, Pointer(Pointer(Void)).null)
    end
    # Predicate alias for `is_paused`
    def is_paused?() : Bool
      is_paused()
    end
    # Predicate alias for `is_paused`
    ...
    def set_volume(volume : Float64) : Void
      ...
      arg_0 = pointerof(val_0).as(Void*)
      args = StaticArray[arg_0]
      godot_ptrcall_void(@@mb_set_volume, @pointer, args.to_unsafe.as(Void**))
    end
    ...
    def get_volume() : Float64
      ...
      godot_ptrcall_float(@@mb_get_volume, @pointer, Pointer(Pointer(Void)).null)
    end
    ...
    def get_volume_db() : Float64
      ...
      godot_ptrcall_float(@@mb_get_volume_db, @pointer, Pointer(Pointer(Void)).null)
    end
    ...
    def get_speed_scale() : Float64
      ...
      godot_ptrcall_float(@@mb_get_speed_scale, @pointer, Pointer(Pointer(Void)).null)
    end
    ...
    def set_audio_track(track : Int64) : Void
      ...
      arg_0 = pointerof(val_0).as(Void*)
      args = StaticArray[arg_0]
      godot_ptrcall_void(@@mb_set_audio_track, @pointer, args.to_unsafe.as(Void**))
    end
    ...
    def get_audio_track() : Int64
      ...
      godot_ptrcall_int(@@mb_get_audio_track, @pointer, Pointer(Pointer(Void)).null)
    end
    ...
    def get_stream_length() : Float64
      ...
      godot_ptrcall_float(@@mb_get_stream_length, @pointer, Pointer(Pointer(Void)).null)
    end
    ...
    def set_stream_position(position : Float64) : Void
      ...
      val_0 = position.to_f64
      arg_0 = pointerof(val_0).as(Void*)
      args = StaticArray[arg_0]
      godot_ptrcall_void(@@mb_set_stream_position, @pointer, args.to_unsafe.as(Void**))
    end
    ...
    def get_stream_position() : Float64
      ...
      godot_ptrcall_float(@@mb_get_stream_position, @pointer, Pointer(Pointer(Void)).null)
    end
    ...
    def set_autoplay(enabled : Bool) : Void
      ...
      arg_0 = pointerof(val_0).as(Void*)
      args = StaticArray[arg_0]
      godot_ptrcall_void(@@mb_set_autoplay, @pointer, args.to_unsafe.as(Void**))
    end
    ...
    def has_autoplay() : Bool
      ...
      godot_ptrcall_bool(@@mb_has_autoplay, @pointer, Pointer(Pointer(Void)).null)
    end
    # Predicate alias for `has_autoplay`
    def has_autoplay?() : Bool
      has_autoplay()
    end
    ...
    def set_expand(enable : Bool) : Void
      ...
      arg_0 = pointerof(val_0).as(Void*)
      args = StaticArray[arg_0]
      godot_ptrcall_void(@@mb_set_expand, @pointer, args.to_unsafe.as(Void**))
    end
    @@mb_has_expand : Void* = Pointer(Void).null
    def has_expand() : Bool
      godot_bind(@@mb_has_expand, "VideoStreamPlayer", "has_expand", 36873697_i64)
      godot_ptrcall_bool(@@mb_has_expand, @pointer, Pointer(Pointer(Void)).null)
    end
    # Predicate alias for `has_expand`
    def has_expand?() : Bool
      has_expand()
    end
    ...
    def set_buffering_msec(msec : Int64) : Void
      ...
      arg_0 = pointerof(val_0).as(Void*)
      args = StaticArray[arg_0]
      godot_ptrcall_void(@@mb_set_buffering_msec, @pointer, args.to_unsafe.as(Void**))
    end
    ...
    def get_buffering_msec() : Int64
      ...
      godot_ptrcall_int(@@mb_get_buffering_msec, @pointer, Pointer(Pointer(Void)).null)
    end
    ...
    def set_bus(bus : String) : Void
      ...
      arg_0 = sn_0
      args = StaticArray[arg_0]
      godot_ptrcall_void(@@mb_set_bus, @pointer, args.to_unsafe.as(Void**))
    ensure
    ...
    def get_video_texture() : Texture2D
      ...
      godot_ptrcall_obj(@@mb_get_video_texture, @pointer, Pointer(Pointer(Void)).null, Texture2D)
    end
  ...
  class ViewportTexture < Godot::Texture2D
    ...
    def set_viewport_path_in_scene(path : NodePath | String) : Void
      ...
      arg_0 = np_0
      args = StaticArray[arg_0]
      godot_ptrcall_void(@@mb_set_viewport_path_in_scene, @pointer, args.to_unsafe.as(Void**))
    ensure
  ...
  class VirtualJoystick < Godot::Control
    ...
    def set_joystick_mode(mode : JoystickMode | Int) : Void
      ...
      arg_0 = pointerof(val_0).as(Void*)
      args = StaticArray[arg_0]
      godot_ptrcall_void(@@mb_set_joystick_mode, @pointer, args.to_unsafe.as(Void**))
    end
    ...
    def get_joystick_mode() : JoystickMode
      ...
      godot_ptrcall_enum(@@mb_get_joystick_mode, @pointer, Pointer(Pointer(Void)).null, JoystickMode)
    end
    ...
    def set_joystick_size(size : Float64) : Void
      ...
      arg_0 = pointerof(val_0).as(Void*)
      args = StaticArray[arg_0]
      godot_ptrcall_void(@@mb_set_joystick_size, @pointer, args.to_unsafe.as(Void**))
    end
    ...
    def get_joystick_size() : Float64
      ...
      godot_ptrcall_float(@@mb_get_joystick_size, @pointer, Pointer(Pointer(Void)).null)
    end
    ...
    def set_tip_size(size : Float64) : Void
      ...
      arg_0 = pointerof(val_0).as(Void*)
      args = StaticArray[arg_0]
      godot_ptrcall_void(@@mb_set_tip_size, @pointer, args.to_unsafe.as(Void**))
    end
    ...
    def get_tip_size() : Float64
      ...
      godot_ptrcall_float(@@mb_get_tip_size, @pointer, Pointer(Pointer(Void)).null)
    end
    ...
    def set_deadzone_ratio(ratio : Float64) : Void
      ...
      arg_0 = pointerof(val_0).as(Void*)
      args = StaticArray[arg_0]
      godot_ptrcall_void(@@mb_set_deadzone_ratio, @pointer, args.to_unsafe.as(Void**))
    end
    ...
    def get_deadzone_ratio() : Float64
      ...
      godot_ptrcall_float(@@mb_get_deadzone_ratio, @pointer, Pointer(Pointer(Void)).null)
    end
    ...
    def set_clampzone_ratio(ratio : Float64) : Void
      ...
      arg_0 = pointerof(val_0).as(Void*)
      args = StaticArray[arg_0]
      godot_ptrcall_void(@@mb_set_clampzone_ratio, @pointer, args.to_unsafe.as(Void**))
    end
    ...
    def get_clampzone_ratio() : Float64
      ...
      godot_ptrcall_float(@@mb_get_clampzone_ratio, @pointer, Pointer(Pointer(Void)).null)
    end
    ...
    def set_initial_offset_ratio(ratio : Vector2) : Void
      ...
      arg_0 = pointerof(val_0).as(Void*)
      args = StaticArray[arg_0]
      godot_ptrcall_void(@@mb_set_initial_offset_ratio, @pointer, args.to_unsafe.as(Void**))
    end
    ...
    def get_initial_offset_ratio() : Vector2
      ...
      godot_ptrcall_val(@@mb_get_initial_offset_ratio, @pointer, Pointer(Pointer(Void)).null, Vector2)
    end
    ...
    def set_action_left(action : String) : Void
      ...
      arg_0 = sn_0
      args = StaticArray[arg_0]
      godot_ptrcall_void(@@mb_set_action_left, @pointer, args.to_unsafe.as(Void**))
    ensure
      Bridge.free_string_name(sn_0)
    end
    ...
    def set_action_right(action : String) : Void
      ...
      arg_0 = sn_0
      args = StaticArray[arg_0]
      godot_ptrcall_void(@@mb_set_action_right, @pointer, args.to_unsafe.as(Void**))
    ensure
      Bridge.free_string_name(sn_0)
    end
    ...
    def set_action_up(action : String) : Void
      ...
      arg_0 = sn_0
      args = StaticArray[arg_0]
      godot_ptrcall_void(@@mb_set_action_up, @pointer, args.to_unsafe.as(Void**))
    ensure
      Bridge.free_string_name(sn_0)
    end
    ...
    def set_action_down(action : String) : Void
      ...
      arg_0 = sn_0
      args = StaticArray[arg_0]
      godot_ptrcall_void(@@mb_set_action_down, @pointer, args.to_unsafe.as(Void**))
    ensure
      Bridge.free_string_name(sn_0)
    end
    ...
    def set_visibility_mode(mode : VisibilityMode | Int) : Void
      ...
      arg_0 = pointerof(val_0).as(Void*)
      args = StaticArray[arg_0]
      godot_ptrcall_void(@@mb_set_visibility_mode, @pointer, args.to_unsafe.as(Void**))
    end
    ...
    def get_visibility_mode() : VisibilityMode
      ...
      godot_ptrcall_enum(@@mb_get_visibility_mode, @pointer, Pointer(Pointer(Void)).null, VisibilityMode)
    end
  ...
  class VisibleOnScreenNotifier2D < Godot::Node2D
    ...
    def set_rect(rect : Rect2) : Void
      ...
      arg_0 = pointerof(val_0).as(Void*)
      args = StaticArray[arg_0]
      godot_ptrcall_void(@@mb_set_rect, @pointer, args.to_unsafe.as(Void**))
    end
    @@mb_get_rect : Void* = Pointer(Void).null
    def get_rect() : Rect2
      godot_bind(@@mb_get_rect, "VisibleOnScreenNotifier2D", "get_rect", 1639390495_i64)
      godot_ptrcall_val(@@mb_get_rect, @pointer, Pointer(Pointer(Void)).null, Rect2)
    end
    ...
    def set_show_rect(show_rect : Bool) : Void
      ...
      arg_0 = pointerof(val_0).as(Void*)
      args = StaticArray[arg_0]
      godot_ptrcall_void(@@mb_set_show_rect, @pointer, args.to_unsafe.as(Void**))
    end
    ...
    def is_showing_rect() : Bool
      ...
      godot_ptrcall_bool(@@mb_is_showing_rect, @pointer, Pointer(Pointer(Void)).null)
    end
    # Predicate alias for `is_showing_rect`
    def is_showing_rect?() : Bool
      is_showing_rect()
    end
    # Predicate alias for `is_showing_rect`
    def showing_rect?() : Bool
      is_showing_rect()
    end
    ...
    def is_on_screen() : Bool
      ...
      godot_ptrcall_bool(@@mb_is_on_screen, @pointer, Pointer(Pointer(Void)).null)
    end
    # Predicate alias for `is_on_screen`
    def is_on_screen?() : Bool
      is_on_screen()
    end
    # Predicate alias for `is_on_screen`
  ...
  class VisibleOnScreenEnabler2D < Godot::VisibleOnScreenNotifier2D
    ...
    def set_enable_mode(mode : EnableMode | Int) : Void
      ...
      arg_0 = pointerof(val_0).as(Void*)
      args = StaticArray[arg_0]
      godot_ptrcall_void(@@mb_set_enable_mode, @pointer, args.to_unsafe.as(Void**))
    end
    ...
    def get_enable_mode() : EnableMode
      ...
      godot_ptrcall_enum(@@mb_get_enable_mode, @pointer, Pointer(Pointer(Void)).null, EnableMode)
    end
    ...
    def set_enable_node_path(path : NodePath | String) : Void
      ...
      arg_0 = np_0
      args = StaticArray[arg_0]
      godot_ptrcall_void(@@mb_set_enable_node_path, @pointer, args.to_unsafe.as(Void**))
    ensure
      Bridge.free_nodepath(np_0)
    end
  ...
  class VisibleOnScreenNotifier3D < Godot::VisualInstance3D
    ...
    def set_aabb(rect : AABB) : Void
      ...
      arg_0 = pointerof(val_0).as(Void*)
      args = StaticArray[arg_0]
      godot_ptrcall_void(@@mb_set_aabb, @pointer, args.to_unsafe.as(Void**))
    end
    @@mb_is_on_screen : Void* = Pointer(Void).null
    def is_on_screen() : Bool
  ...
  class VisualShader < Godot::Shader
    ...
    def set_mode(mode : Godot::Shader::Mode | Int) : Void
      ...
      arg_0 = pointerof(val_0).as(Void*)
      args = StaticArray[arg_0]
      godot_ptrcall_void(@@mb_set_mode, @pointer, args.to_unsafe.as(Void**))
    end
    ...
    def add_node(get_type : Type | Int, node : VisualShaderNode, position : Vector2, id : Int64) : Void
      ...
      godot_ptrcall_void(@@mb_add_node, @pointer, args.to_unsafe.as(Void**))
    end
    ...
    def get_node(get_type : Type | Int, id : Int64) : VisualShaderNode
      ...
      godot_ptrcall_obj(@@mb_get_node, @pointer, args.to_unsafe.as(Void**), VisualShaderNode)
    end
    ...
    def set_node_position(get_type : Type | Int, id : Int64, position : Vector2) : Void
      ...
      arg_2 = pointerof(val_2).as(Void*)
      args = StaticArray[arg_0, arg_1, arg_2]
      godot_ptrcall_void(@@mb_set_node_position, @pointer, args.to_unsafe.as(Void**))
    end
    ...
    def get_node_position(get_type : Type | Int, id : Int64) : Vector2
      ...
      arg_1 = pointerof(val_1).as(Void*)
      args = StaticArray[arg_0, arg_1]
      godot_ptrcall_val(@@mb_get_node_position, @pointer, args.to_unsafe.as(Void**), Vector2)
    end
    ...
    def get_node_list(get_type : Type | Int) : Pointer(Void)
      ...
      godot_ptrcall(@@mb_get_node_list, @pointer, args.to_unsafe.as(Void**), ret_buf.to_unsafe.as(Void*))
    ...
    def get_valid_node_id(get_type : Type | Int) : Int64
      ...
      arg_0 = pointerof(val_0).as(Void*)
      args = StaticArray[arg_0]
      godot_ptrcall_int(@@mb_get_valid_node_id, @pointer, args.to_unsafe.as(Void**))
    end
    ...
    def remove_node(get_type : Type | Int, id : Int64) : Void
      ...
      arg_1 = pointerof(val_1).as(Void*)
      args = StaticArray[arg_0, arg_1]
      godot_ptrcall_void(@@mb_remove_node, @pointer, args.to_unsafe.as(Void**))
    end
    ...
    def replace_node(get_type : Type | Int, id : Int64, new_class : String) : Void
      ...
      arg_2 = sn_2
      args = StaticArray[arg_0, arg_1, arg_2]
      godot_ptrcall_void(@@mb_replace_node, @pointer, args.to_unsafe.as(Void**))
    ensure
    ...
    def is_node_connection(get_type : Type | Int, from_node : Int64, from_port : Int64, to_node : Int64, to_port : Int64) : Bool
      ...
      val_0 = get_type.is_a?(Int) ? get_type.to_i64 : get_type.value.to_i64
      arg_0 = pointerof(val_0).as(Void*)
      val_1 = from_node.to_i64
      arg_1 = pointerof(val_1).as(Void*)
      val_2 = from_port.to_i64
      arg_2 = pointerof(val_2).as(Void*)
      val_3 = to_node.to_i64
      arg_3 = pointerof(val_3).as(Void*)
      val_4 = to_port.to_i64
      arg_4 = pointerof(val_4).as(Void*)
      args = StaticArray[arg_0, arg_1, arg_2, arg_3, arg_4]
      godot_ptrcall_bool(@@mb_is_node_connection, @pointer, args.to_unsafe.as(Void**))
    end
    # Predicate alias for `is_node_connection`
    def is_node_connection?(get_type : Type | Int, from_node : Int64, from_port : Int64, to_node : Int64, to_port : Int64) : Bool
      is_node_connection(get_type, from_node, from_port, to_node, to_port)
    end
    # Predicate alias for `is_node_connection`
    def node_connection?(get_type : Type | Int, from_node : Int64, from_port : Int64, to_node : Int64, to_port : Int64) : Bool
      is_node_connection(get_type, from_node, from_port, to_node, to_port)
    end
    ...
    def can_connect_nodes(get_type : Type | Int, from_node : Int64, from_port : Int64, to_node : Int64, to_port : Int64) : Bool
      ...
      arg_4 = pointerof(val_4).as(Void*)
      args = StaticArray[arg_0, arg_1, arg_2, arg_3, arg_4]
      godot_ptrcall_bool(@@mb_can_connect_nodes, @pointer, args.to_unsafe.as(Void**))
    end
    # Predicate alias for `can_connect_nodes`
    def can_connect_nodes?(get_type : Type | Int, from_node : Int64, from_port : Int64, to_node : Int64, to_port : Int64) : Bool
      can_connect_nodes(get_type, from_node, from_port, to_node, to_port)
    end
    ...
    def connect_nodes(get_type : Type | Int, from_node : Int64, from_port : Int64, to_node : Int64, to_port : Int64) : Godot::Error
      ...
      arg_4 = pointerof(val_4).as(Void*)
      args = StaticArray[arg_0, arg_1, arg_2, arg_3, arg_4]
      godot_ptrcall_enum(@@mb_connect_nodes, @pointer, args.to_unsafe.as(Void**), Godot::Error)
    end
    ...
    def disconnect_nodes(get_type : Type | Int, from_node : Int64, from_port : Int64, to_node : Int64, to_port : Int64) : Void
      ...
      arg_4 = pointerof(val_4).as(Void*)
      args = StaticArray[arg_0, arg_1, arg_2, arg_3, arg_4]
      godot_ptrcall_void(@@mb_disconnect_nodes, @pointer, args.to_unsafe.as(Void**))
    end
    ...
    def connect_nodes_forced(get_type : Type | Int, from_node : Int64, from_port : Int64, to_node : Int64, to_port : Int64) : Void
      ...
      arg_4 = pointerof(val_4).as(Void*)
      args = StaticArray[arg_0, arg_1, arg_2, arg_3, arg_4]
      godot_ptrcall_void(@@mb_connect_nodes_forced, @pointer, args.to_unsafe.as(Void**))
    end
    ...
    def attach_node_to_frame(get_type : Type | Int, id : Int64, frame : Int64) : Void
      ...
      arg_2 = pointerof(val_2).as(Void*)
      args = StaticArray[arg_0, arg_1, arg_2]
      godot_ptrcall_void(@@mb_attach_node_to_frame, @pointer, args.to_unsafe.as(Void**))
    end
    ...
    def detach_node_from_frame(get_type : Type | Int, id : Int64) : Void
      ...
      arg_1 = pointerof(val_1).as(Void*)
      args = StaticArray[arg_0, arg_1]
      godot_ptrcall_void(@@mb_detach_node_from_frame, @pointer, args.to_unsafe.as(Void**))
    end
    ...
    def add_varying(name : String, mode : VaryingMode | Int, get_type : VaryingType | Int) : Void
      ...
      arg_2 = pointerof(val_2).as(Void*)
      args = StaticArray[arg_0, arg_1, arg_2]
      godot_ptrcall_void(@@mb_add_varying, @pointer, args.to_unsafe.as(Void**))
    ensure
      Bridge.free_string(str_0)
    end
    ...
    def remove_varying(name : String) : Void
      ...
      arg_0 = str_0
      args = StaticArray[arg_0]
      godot_ptrcall_void(@@mb_remove_varying, @pointer, args.to_unsafe.as(Void**))
    ensure
      Bridge.free_string(str_0)
    end
    ...
    def has_varying(name : String) : Bool
      ...
      arg_0 = str_0
      args = StaticArray[arg_0]
      godot_ptrcall_bool(@@mb_has_varying, @pointer, args.to_unsafe.as(Void**))
    ensure
      Bridge.free_string(str_0)
    end
    # Predicate alias for `has_varying`
    def has_varying?(name : String) : Bool
      has_varying(name)
    end
    ...
    def set_graph_offset(offset : Vector2) : Void
      ...
      arg_0 = pointerof(val_0).as(Void*)
      args = StaticArray[arg_0]
      godot_ptrcall_void(@@mb_set_graph_offset, @pointer, args.to_unsafe.as(Void**))
    end
    ...
    def get_graph_offset() : Vector2
      ...
      godot_ptrcall_val(@@mb_get_graph_offset, @pointer, Pointer(Pointer(Void)).null, Vector2)
    end
  ...
  class VisualShaderGroup < Godot::Resource
    ...
    def set_group_name(name : String) : Void
      ...
      arg_0 = str_0
      args = StaticArray[arg_0]
      godot_ptrcall_void(@@mb_set_group_name, @pointer, args.to_unsafe.as(Void**))
    ensure
      Bridge.free_string(str_0)
    end
    ...
    def remove_input_port(id : Int64) : Void
      ...
      arg_0 = pointerof(val_0).as(Void*)
      args = StaticArray[arg_0]
      godot_ptrcall_void(@@mb_remove_input_port, @pointer, args.to_unsafe.as(Void**))
    end
    ...
    def move_input_port(from : Int64, to : Int64) : Void
      ...
      arg_1 = pointerof(val_1).as(Void*)
      args = StaticArray[arg_0, arg_1]
      godot_ptrcall_void(@@mb_move_input_port, @pointer, args.to_unsafe.as(Void**))
    end
    ...
    def set_input_port_name(id : Int64, name : String) : Void
      ...
      arg_1 = str_1
      args = StaticArray[arg_0, arg_1]
      godot_ptrcall_void(@@mb_set_input_port_name, @pointer, args.to_unsafe.as(Void**))
    ensure
    ...
    def set_input_port_type(id : Int64, get_type : Godot::VisualShaderNode::PortType | Int) : Void
      ...
      arg_1 = pointerof(val_1).as(Void*)
      args = StaticArray[arg_0, arg_1]
      godot_ptrcall_void(@@mb_set_input_port_type, @pointer, args.to_unsafe.as(Void**))
    end
    ...
    def set_input_port_count(count : Int64) : Void
      ...
      arg_0 = pointerof(val_0).as(Void*)
      args = StaticArray[arg_0]
      godot_ptrcall_void(@@mb_set_input_port_count, @pointer, args.to_unsafe.as(Void**))
    end
    ...
    def get_input_port_count() : Int64
      ...
      godot_ptrcall_int(@@mb_get_input_port_count, @pointer, Pointer(Pointer(Void)).null)
    end
    ...
    def get_input_port_type(id : Int64) : Godot::VisualShaderNode::PortType
      ...
      arg_0 = pointerof(val_0).as(Void*)
      args = StaticArray[arg_0]
      godot_ptrcall_enum(@@mb_get_input_port_type, @pointer, args.to_unsafe.as(Void**), Godot::VisualShaderNode::PortType)
    end
    ...
    def remove_output_port(id : Int64) : Void
      ...
      arg_0 = pointerof(val_0).as(Void*)
      args = StaticArray[arg_0]
      godot_ptrcall_void(@@mb_remove_output_port, @pointer, args.to_unsafe.as(Void**))
    end
    ...
    def move_output_port(from : Int64, to : Int64) : Void
      ...
      arg_1 = pointerof(val_1).as(Void*)
      args = StaticArray[arg_0, arg_1]
      godot_ptrcall_void(@@mb_move_output_port, @pointer, args.to_unsafe.as(Void**))
    end
    ...
    def set_output_port_name(id : Int64, name : String) : Void
      ...
      arg_1 = str_1
      args = StaticArray[arg_0, arg_1]
      godot_ptrcall_void(@@mb_set_output_port_name, @pointer, args.to_unsafe.as(Void**))
    ensure
      Bridge.free_string(str_1)
    end
    ...
    def set_output_port_type(id : Int64, get_type : Godot::VisualShaderNode::PortType | Int) : Void
      ...
      arg_1 = pointerof(val_1).as(Void*)
      args = StaticArray[arg_0, arg_1]
      godot_ptrcall_void(@@mb_set_output_port_type, @pointer, args.to_unsafe.as(Void**))
    end
    ...
    def set_output_port_count(count : Int64) : Void
      ...
      arg_0 = pointerof(val_0).as(Void*)
      args = StaticArray[arg_0]
      godot_ptrcall_void(@@mb_set_output_port_count, @pointer, args.to_unsafe.as(Void**))
    end
    ...
    def get_output_port_count() : Int64
      ...
      godot_ptrcall_int(@@mb_get_output_port_count, @pointer, Pointer(Pointer(Void)).null)
    end
    ...
    def get_output_port_type(id : Int64) : Godot::VisualShaderNode::PortType
      ...
      arg_0 = pointerof(val_0).as(Void*)
      args = StaticArray[arg_0]
      godot_ptrcall_enum(@@mb_get_output_port_type, @pointer, args.to_unsafe.as(Void**), Godot::VisualShaderNode::PortType)
    end
    @@mb_add_node : Void* = Pointer(Void).null
    ...
    def get_node_list() : Pointer(Void)
      ...
      ret_buf = StaticArray(Pointer(Void), 2).new(Pointer(Void).null)
      godot_ptrcall(@@mb_get_node_list, @pointer, Pointer(Pointer(Void)).null, ret_buf.to_unsafe.as(Void*))
      ret_buf[0].null? ? ret_buf[1] : ret_buf[0]
    end
    @@mb_get_valid_node_id : Void* = Pointer(Void).null
    def get_valid_node_id() : Int64
      godot_bind(@@mb_get_valid_node_id, "VisualShaderGroup", "get_valid_node_id", 3905245786_i64)
      godot_ptrcall_int(@@mb_get_valid_node_id, @pointer, Pointer(Pointer(Void)).null)
    end
    @@mb_remove_node : Void* = Pointer(Void).null
    ...
    def is_node_connection(from_node : Int64, from_port : Int64, to_node : Int64, to_port : Int64) : Bool
      ...
      val_0 = from_node.to_i64
      arg_0 = pointerof(val_0).as(Void*)
      val_1 = from_port.to_i64
      arg_1 = pointerof(val_1).as(Void*)
      val_2 = to_node.to_i64
      arg_2 = pointerof(val_2).as(Void*)
      val_3 = to_port.to_i64
      arg_3 = pointerof(val_3).as(Void*)
      args = StaticArray[arg_0, arg_1, arg_2, arg_3]
      godot_ptrcall_bool(@@mb_is_node_connection, @pointer, args.to_unsafe.as(Void**))
    end
    # Predicate alias for `is_node_connection`
    def is_node_connection?(from_node : Int64, from_port : Int64, to_node : Int64, to_port : Int64) : Bool
      is_node_connection(from_node, from_port, to_node, to_port)
    end
    # Predicate alias for `is_node_connection`
    def node_connection?(from_node : Int64, from_port : Int64, to_node : Int64, to_port : Int64) : Bool
      is_node_connection(from_node, from_port, to_node, to_port)
    end
    @@mb_can_connect_nodes : Void* = Pointer(Void).null
    ...
    # Predicate alias for `can_connect_nodes`
    def can_connect_nodes?(from_node : Int64, from_port : Int64, to_node : Int64, to_port : Int64) : Bool
      can_connect_nodes(from_node, from_port, to_node, to_port)
    end
    @@mb_connect_nodes : Void* = Pointer(Void).null
  ...
  class VisualShaderNode < Godot::Resource
    ...
    def get_default_input_port(get_type : PortType | Int) : Int64
      ...
      arg_0 = pointerof(val_0).as(Void*)
      args = StaticArray[arg_0]
      godot_ptrcall_int(@@mb_get_default_input_port, @pointer, args.to_unsafe.as(Void**))
    end
    ...
    def set_output_port_for_preview(port : Int64) : Void
      ...
      arg_0 = pointerof(val_0).as(Void*)
      args = StaticArray[arg_0]
      godot_ptrcall_void(@@mb_set_output_port_for_preview, @pointer, args.to_unsafe.as(Void**))
    end
    ...
    def get_output_port_for_preview() : Int64
      ...
      godot_ptrcall_int(@@mb_get_output_port_for_preview, @pointer, Pointer(Pointer(Void)).null)
    end
    ...
    def set_input_port_default_value(port : Int64, value : Pointer(Void), prev_value : Pointer(Void)? = nil) : Void
      ...
      arg_2 = pointerof(val_2).as(Void*)
      args = StaticArray[arg_0, arg_1, arg_2]
      godot_ptrcall_void(@@mb_set_input_port_default_value, @pointer, args.to_unsafe.as(Void**))
    end
    ...
    def remove_input_port_default_value(port : Int64) : Void
      ...
      arg_0 = pointerof(val_0).as(Void*)
      args = StaticArray[arg_0]
      godot_ptrcall_void(@@mb_remove_input_port_default_value, @pointer, args.to_unsafe.as(Void**))
    end
    ...
    def clear_default_input_values() : Void
      ...
      godot_ptrcall_void(@@mb_clear_default_input_values, @pointer, Pointer(Pointer(Void)).null)
    end
    ...
    def set_default_input_values(values : Pointer(Void)) : Void
      ...
      arg_0 = pointerof(val_0).as(Void*)
      args = StaticArray[arg_0]
      godot_ptrcall_void(@@mb_set_default_input_values, @pointer, args.to_unsafe.as(Void**))
    end
    ...
    def get_frame() : Int64
      ...
      godot_ptrcall_int(@@mb_get_frame, @pointer, Pointer(Pointer(Void)).null)
    end
  ...
  class VisualShaderNodeBillboard < Godot::VisualShaderNode
    ...
    def set_billboard_type(billboard_type : BillboardType | Int) : Void
      ...
      arg_0 = pointerof(val_0).as(Void*)
      args = StaticArray[arg_0]
      godot_ptrcall_void(@@mb_set_billboard_type, @pointer, args.to_unsafe.as(Void**))
    end
    ...
    def get_billboard_type() : BillboardType
      ...
      godot_ptrcall_enum(@@mb_get_billboard_type, @pointer, Pointer(Pointer(Void)).null, BillboardType)
    end
    ...
    def set_keep_scale_enabled(enabled : Bool) : Void
      ...
      arg_0 = pointerof(val_0).as(Void*)
      args = StaticArray[arg_0]
      godot_ptrcall_void(@@mb_set_keep_scale_enabled, @pointer, args.to_unsafe.as(Void**))
    end
    ...
    def is_keep_scale_enabled() : Bool
      ...
      godot_ptrcall_bool(@@mb_is_keep_scale_enabled, @pointer, Pointer(Pointer(Void)).null)
    end
    # Predicate alias for `is_keep_scale_enabled`
    def is_keep_scale_enabled?() : Bool
      is_keep_scale_enabled()
    end
    # Predicate alias for `is_keep_scale_enabled`
    def keep_scale_enabled?() : Bool
      is_keep_scale_enabled()
    end
  ...
  class VisualShaderNodeBooleanConstant < Godot::VisualShaderNodeConstant
    ...
    def set_constant(constant : Bool) : Void
      ...
      arg_0 = pointerof(val_0).as(Void*)
      args = StaticArray[arg_0]
      godot_ptrcall_void(@@mb_set_constant, @pointer, args.to_unsafe.as(Void**))
    end
    ...
    def get_constant() : Bool
      ...
      godot_ptrcall_bool(@@mb_get_constant, @pointer, Pointer(Pointer(Void)).null)
    end
    # Predicate alias for `get_constant`
    def get_constant?() : Bool
      get_constant()
    end
  ...
  class VisualShaderNodeParameter < Godot::VisualShaderNode
    ...
    def set_parameter_name(name : String) : Void
      ...
      arg_0 = str_0
      args = StaticArray[arg_0]
      godot_ptrcall_void(@@mb_set_parameter_name, @pointer, args.to_unsafe.as(Void**))
    ensure
      Bridge.free_string(str_0)
    end
    ...
    def set_qualifier(qualifier : Qualifier | Int) : Void
      ...
      arg_0 = pointerof(val_0).as(Void*)
      args = StaticArray[arg_0]
      godot_ptrcall_void(@@mb_set_qualifier, @pointer, args.to_unsafe.as(Void**))
    end
    ...
    def get_qualifier() : Qualifier
      ...
      godot_ptrcall_enum(@@mb_get_qualifier, @pointer, Pointer(Pointer(Void)).null, Qualifier)
    end
    ...
    def set_instance_index(instance_index : Int64) : Void
      ...
      val_0 = instance_index.to_i64
      arg_0 = pointerof(val_0).as(Void*)
      args = StaticArray[arg_0]
      godot_ptrcall_void(@@mb_set_instance_index, @pointer, args.to_unsafe.as(Void**))
    end
    ...
    def get_instance_index() : Int64
      ...
      godot_ptrcall_int(@@mb_get_instance_index, @pointer, Pointer(Pointer(Void)).null)
    end
  ...
  class VisualShaderNodeBooleanParameter < Godot::VisualShaderNodeParameter
    ...
    def set_default_value_enabled(enabled : Bool) : Void
      ...
      arg_0 = pointerof(val_0).as(Void*)
      args = StaticArray[arg_0]
      godot_ptrcall_void(@@mb_set_default_value_enabled, @pointer, args.to_unsafe.as(Void**))
    end
    ...
    def is_default_value_enabled() : Bool
      ...
      godot_ptrcall_bool(@@mb_is_default_value_enabled, @pointer, Pointer(Pointer(Void)).null)
    end
    # Predicate alias for `is_default_value_enabled`
    def is_default_value_enabled?() : Bool
      is_default_value_enabled()
    end
    # Predicate alias for `is_default_value_enabled`
    def default_value_enabled?() : Bool
      is_default_value_enabled()
    end
    ...
    def set_default_value(value : Bool) : Void
      ...
      arg_0 = pointerof(val_0).as(Void*)
      args = StaticArray[arg_0]
      godot_ptrcall_void(@@mb_set_default_value, @pointer, args.to_unsafe.as(Void**))
    end
    ...
    def get_default_value() : Bool
      ...
      godot_ptrcall_bool(@@mb_get_default_value, @pointer, Pointer(Pointer(Void)).null)
    end
    # Predicate alias for `get_default_value`
    def get_default_value?() : Bool
      get_default_value()
    end
  ...
  class VisualShaderNodeClamp < Godot::VisualShaderNode
    ...
    def set_op_type(op_type : OpType | Int) : Void
      ...
      arg_0 = pointerof(val_0).as(Void*)
      args = StaticArray[arg_0]
      godot_ptrcall_void(@@mb_set_op_type, @pointer, args.to_unsafe.as(Void**))
    end
    ...
    def get_op_type() : OpType
      ...
      godot_ptrcall_enum(@@mb_get_op_type, @pointer, Pointer(Pointer(Void)).null, OpType)
    end
  ...
  class VisualShaderNodeColorConstant < Godot::VisualShaderNodeConstant
    ...
    def get_constant() : Color
      ...
      godot_ptrcall_val(@@mb_get_constant, @pointer, Pointer(Pointer(Void)).null, Color)
    end
    # Property `constant` getter
    def constant
      get_constant
  ...
  class VisualShaderNodeColorFunc < Godot::VisualShaderNode
    ...
    def set_function(func : Function | Int) : Void
      ...
      arg_0 = pointerof(val_0).as(Void*)
      args = StaticArray[arg_0]
      godot_ptrcall_void(@@mb_set_function, @pointer, args.to_unsafe.as(Void**))
    end
    ...
    def get_function() : Function
      ...
      godot_ptrcall_enum(@@mb_get_function, @pointer, Pointer(Pointer(Void)).null, Function)
    end
  ...
  class VisualShaderNodeColorOp < Godot::VisualShaderNode
    ...
    def set_operator(op : Operator | Int) : Void
      ...
      arg_0 = pointerof(val_0).as(Void*)
      args = StaticArray[arg_0]
      godot_ptrcall_void(@@mb_set_operator, @pointer, args.to_unsafe.as(Void**))
    end
    ...
    def get_operator() : Operator
      ...
      godot_ptrcall_enum(@@mb_get_operator, @pointer, Pointer(Pointer(Void)).null, Operator)
    end
  ...
  class VisualShaderNodeColorParameter < Godot::VisualShaderNodeParameter
    ...
    def get_default_value() : Color
      ...
      godot_ptrcall_val(@@mb_get_default_value, @pointer, Pointer(Pointer(Void)).null, Color)
    end
    # Property `default_value_enabled` getter
    def default_value_enabled
      is_default_value_enabled
  ...
  class VisualShaderNodeFrame < Godot::VisualShaderNodeResizableBase
    ...
    def set_title(title : String) : Void
      ...
      arg_0 = str_0
      args = StaticArray[arg_0]
      godot_ptrcall_void(@@mb_set_title, @pointer, args.to_unsafe.as(Void**))
    ensure
      Bridge.free_string(str_0)
    end
    ...
    def set_tint_color_enabled(enable : Bool) : Void
      ...
      arg_0 = pointerof(val_0).as(Void*)
      args = StaticArray[arg_0]
      godot_ptrcall_void(@@mb_set_tint_color_enabled, @pointer, args.to_unsafe.as(Void**))
    end
    ...
    def is_tint_color_enabled() : Bool
      ...
      godot_ptrcall_bool(@@mb_is_tint_color_enabled, @pointer, Pointer(Pointer(Void)).null)
    end
    # Predicate alias for `is_tint_color_enabled`
    def is_tint_color_enabled?() : Bool
      is_tint_color_enabled()
    end
    # Predicate alias for `is_tint_color_enabled`
    def tint_color_enabled?() : Bool
      is_tint_color_enabled()
    end
    ...
    def set_tint_color(color : Color) : Void
      ...
      arg_0 = pointerof(val_0).as(Void*)
      args = StaticArray[arg_0]
      godot_ptrcall_void(@@mb_set_tint_color, @pointer, args.to_unsafe.as(Void**))
    end
    ...
    def get_tint_color() : Color
      ...
      godot_ptrcall_val(@@mb_get_tint_color, @pointer, Pointer(Pointer(Void)).null, Color)
    end
    ...
    def set_autoshrink_enabled(enable : Bool) : Void
      ...
      arg_0 = pointerof(val_0).as(Void*)
      args = StaticArray[arg_0]
      godot_ptrcall_void(@@mb_set_autoshrink_enabled, @pointer, args.to_unsafe.as(Void**))
    end
    ...
    def is_autoshrink_enabled() : Bool
      ...
      godot_ptrcall_bool(@@mb_is_autoshrink_enabled, @pointer, Pointer(Pointer(Void)).null)
    end
    # Predicate alias for `is_autoshrink_enabled`
    def is_autoshrink_enabled?() : Bool
      is_autoshrink_enabled()
    end
    # Predicate alias for `is_autoshrink_enabled`
    def autoshrink_enabled?() : Bool
      is_autoshrink_enabled()
    end
    ...
    def add_attached_node(node : Int64) : Void
      ...
      arg_0 = pointerof(val_0).as(Void*)
      args = StaticArray[arg_0]
      godot_ptrcall_void(@@mb_add_attached_node, @pointer, args.to_unsafe.as(Void**))
    end
    ...
    def remove_attached_node(node : Int64) : Void
      ...
      arg_0 = pointerof(val_0).as(Void*)
      args = StaticArray[arg_0]
      godot_ptrcall_void(@@mb_remove_attached_node, @pointer, args.to_unsafe.as(Void**))
    end
    ...
    def set_attached_nodes(attached_nodes : Pointer(Void)) : Void
      ...
      arg_0 = pointerof(val_0).as(Void*)
      args = StaticArray[arg_0]
      godot_ptrcall_void(@@mb_set_attached_nodes, @pointer, args.to_unsafe.as(Void**))
    end
    ...
    def get_attached_nodes() : Pointer(Void)
      ...
      ret_buf = StaticArray(Pointer(Void), 2).new(Pointer(Void).null)
      godot_ptrcall(@@mb_get_attached_nodes, @pointer, Pointer(Pointer(Void)).null, ret_buf.to_unsafe.as(Void*))
      ret_buf[0].null? ? ret_buf[1] : ret_buf[0]
    end
  ...
  class VisualShaderNodeComment < Godot::VisualShaderNodeFrame
    ...
    def set_description(description : String) : Void
      ...
      arg_0 = str_0
      args = StaticArray[arg_0]
      godot_ptrcall_void(@@mb_set_description, @pointer, args.to_unsafe.as(Void**))
    ensure
      Bridge.free_string(str_0)
    end
  ...
  class VisualShaderNodeCompare < Godot::VisualShaderNode
    ...
    def set_comparison_type(get_type : ComparisonType | Int) : Void
      ...
      arg_0 = pointerof(val_0).as(Void*)
      args = StaticArray[arg_0]
      godot_ptrcall_void(@@mb_set_comparison_type, @pointer, args.to_unsafe.as(Void**))
    end
    ...
    def get_comparison_type() : ComparisonType
      ...
      godot_ptrcall_enum(@@mb_get_comparison_type, @pointer, Pointer(Pointer(Void)).null, ComparisonType)
    end
    @@mb_set_function : Void* = Pointer(Void).null
    def set_function(func : Function | Int) : Void
    ...
    def set_condition(condition : Condition | Int) : Void
      ...
      arg_0 = pointerof(val_0).as(Void*)
      args = StaticArray[arg_0]
      godot_ptrcall_void(@@mb_set_condition, @pointer, args.to_unsafe.as(Void**))
    end
    ...
    def get_condition() : Condition
      ...
      godot_ptrcall_enum(@@mb_get_condition, @pointer, Pointer(Pointer(Void)).null, Condition)
    end
  ...
  class VisualShaderNodeCubemap < Godot::VisualShaderNode
    ...
    def set_source(value : Source | Int) : Void
      ...
      arg_0 = pointerof(val_0).as(Void*)
      args = StaticArray[arg_0]
      godot_ptrcall_void(@@mb_set_source, @pointer, args.to_unsafe.as(Void**))
    end
    @@mb_get_source : Void* = Pointer(Void).null
    def get_source() : Source
      godot_bind(@@mb_get_source, "VisualShaderNodeCubemap", "get_source", 2222048781_i64)
      godot_ptrcall_enum(@@mb_get_source, @pointer, Pointer(Pointer(Void)).null, Source)
    end
    ...
    def set_cube_map(value : TextureLayered) : Void
      ...
      arg_0 = pointerof(arg_ptr_0).as(Void*)
      args = StaticArray[arg_0]
      godot_ptrcall_void(@@mb_set_cube_map, @pointer, args.to_unsafe.as(Void**))
    end
    ...
    def get_cube_map() : TextureLayered
      ...
      godot_ptrcall_obj(@@mb_get_cube_map, @pointer, Pointer(Pointer(Void)).null, TextureLayered)
    end
    ...
    def set_texture_type(value : TextureType | Int) : Void
      ...
      arg_0 = pointerof(val_0).as(Void*)
      args = StaticArray[arg_0]
      godot_ptrcall_void(@@mb_set_texture_type, @pointer, args.to_unsafe.as(Void**))
    end
    ...
    def get_texture_type() : TextureType
      ...
      godot_ptrcall_enum(@@mb_get_texture_type, @pointer, Pointer(Pointer(Void)).null, TextureType)
    end
  ...
  class VisualShaderNodeTextureParameter < Godot::VisualShaderNodeParameter
    ...
    def set_color_default(color : ColorDefault | Int) : Void
      ...
      arg_0 = pointerof(val_0).as(Void*)
      args = StaticArray[arg_0]
      godot_ptrcall_void(@@mb_set_color_default, @pointer, args.to_unsafe.as(Void**))
    end
    ...
    def get_color_default() : ColorDefault
      ...
      godot_ptrcall_enum(@@mb_get_color_default, @pointer, Pointer(Pointer(Void)).null, ColorDefault)
    end
    ...
    def set_texture_filter(filter : TextureFilter | Int) : Void
      ...
      arg_0 = pointerof(val_0).as(Void*)
      args = StaticArray[arg_0]
      godot_ptrcall_void(@@mb_set_texture_filter, @pointer, args.to_unsafe.as(Void**))
    end
    ...
    def get_texture_filter() : TextureFilter
      ...
      godot_ptrcall_enum(@@mb_get_texture_filter, @pointer, Pointer(Pointer(Void)).null, TextureFilter)
    end
    ...
    def set_texture_repeat(repeat : TextureRepeat | Int) : Void
      ...
      arg_0 = pointerof(val_0).as(Void*)
      args = StaticArray[arg_0]
      godot_ptrcall_void(@@mb_set_texture_repeat, @pointer, args.to_unsafe.as(Void**))
    end
    ...
    def get_texture_repeat() : TextureRepeat
      ...
      godot_ptrcall_enum(@@mb_get_texture_repeat, @pointer, Pointer(Pointer(Void)).null, TextureRepeat)
    end
    ...
    def set_texture_source(source : TextureSource | Int) : Void
      ...
      arg_0 = pointerof(val_0).as(Void*)
      args = StaticArray[arg_0]
      godot_ptrcall_void(@@mb_set_texture_source, @pointer, args.to_unsafe.as(Void**))
    end
    ...
    def get_texture_source() : TextureSource
      ...
      godot_ptrcall_enum(@@mb_get_texture_source, @pointer, Pointer(Pointer(Void)).null, TextureSource)
    end
    # Property `texture_type` getter
    def texture_type
      get_texture_type
  ...
  class VisualShaderNodeCurveTexture < Godot::VisualShaderNodeResizableBase
    ...
    def set_texture(texture : CurveTexture) : Void
      ...
      arg_0 = pointerof(arg_ptr_0).as(Void*)
      args = StaticArray[arg_0]
      godot_ptrcall_void(@@mb_set_texture, @pointer, args.to_unsafe.as(Void**))
    end
    ...
    def get_texture() : CurveTexture
      ...
      godot_ptrcall_obj(@@mb_get_texture, @pointer, Pointer(Pointer(Void)).null, CurveTexture)
    end
  ...
  class VisualShaderNodeCurveXYZTexture < Godot::VisualShaderNodeResizableBase
    ...
    def get_texture() : CurveXYZTexture
      ...
      godot_ptrcall_obj(@@mb_get_texture, @pointer, Pointer(Pointer(Void)).null, CurveXYZTexture)
    end
    # Property `texture` getter
    def texture
      get_texture
  ...
  class VisualShaderNodeCustom < Godot::VisualShaderNode
    ...
    def get_option_index(option : Int64) : Int64
      ...
      arg_0 = pointerof(val_0).as(Void*)
      args = StaticArray[arg_0]
      godot_ptrcall_int(@@mb_get_option_index, @pointer, args.to_unsafe.as(Void**))
    end
  ...
  class VisualShaderNodeDerivativeFunc < Godot::VisualShaderNode
    ...
    def set_precision(precision : Precision | Int) : Void
      ...
      arg_0 = pointerof(val_0).as(Void*)
      args = StaticArray[arg_0]
      godot_ptrcall_void(@@mb_set_precision, @pointer, args.to_unsafe.as(Void**))
    end
    ...
    def get_precision() : Precision
      ...
      godot_ptrcall_enum(@@mb_get_precision, @pointer, Pointer(Pointer(Void)).null, Precision)
    end
    # Property `op_type` getter
    def op_type
      get_op_type
  ...
  class VisualShaderNodeGroupBase < Godot::VisualShaderNodeResizableBase
    ...
    def set_inputs(inputs : String) : Void
      ...
      arg_0 = str_0
      args = StaticArray[arg_0]
      godot_ptrcall_void(@@mb_set_inputs, @pointer, args.to_unsafe.as(Void**))
    ensure
      Bridge.free_string(str_0)
    end
    ...
    def set_outputs(outputs : String) : Void
      ...
      arg_0 = str_0
      args = StaticArray[arg_0]
      godot_ptrcall_void(@@mb_set_outputs, @pointer, args.to_unsafe.as(Void**))
    ensure
      Bridge.free_string(str_0)
    end
    ...
    def is_valid_port_name(name : String) : Bool
      ...
      arg_0 = str_0
      args = StaticArray[arg_0]
      godot_ptrcall_bool(@@mb_is_valid_port_name, @pointer, args.to_unsafe.as(Void**))
    ensure
      Bridge.free_string(str_0)
    end
    # Predicate alias for `is_valid_port_name`
    def is_valid_port_name?(name : String) : Bool
      is_valid_port_name(name)
    end
    # Predicate alias for `is_valid_port_name`
    def valid_port_name?(name : String) : Bool
      is_valid_port_name(name)
    end
    ...
    def add_input_port(id : Int64, get_type : Int64, name : String) : Void
      ...
      val_0 = id.to_i64
      arg_0 = pointerof(val_0).as(Void*)
      val_1 = get_type.to_i64
      arg_1 = pointerof(val_1).as(Void*)
      str_2 = Bridge.make_string(name)
      arg_2 = str_2
      args = StaticArray[arg_0, arg_1, arg_2]
      godot_ptrcall_void(@@mb_add_input_port, @pointer, args.to_unsafe.as(Void**))
    ensure
      Bridge.free_string(str_2)
    end
    @@mb_remove_input_port : Void* = Pointer(Void).null
    ...
    def has_input_port(id : Int64) : Bool
      ...
      arg_0 = pointerof(val_0).as(Void*)
      args = StaticArray[arg_0]
      godot_ptrcall_bool(@@mb_has_input_port, @pointer, args.to_unsafe.as(Void**))
    end
    # Predicate alias for `has_input_port`
    def has_input_port?(id : Int64) : Bool
      has_input_port(id)
    end
    ...
    def clear_input_ports() : Void
      ...
      godot_ptrcall_void(@@mb_clear_input_ports, @pointer, Pointer(Pointer(Void)).null)
    end
    ...
    def add_output_port(id : Int64, get_type : Int64, name : String) : Void
      ...
      arg_2 = str_2
      args = StaticArray[arg_0, arg_1, arg_2]
      godot_ptrcall_void(@@mb_add_output_port, @pointer, args.to_unsafe.as(Void**))
    ensure
      Bridge.free_string(str_2)
    end
    @@mb_remove_output_port : Void* = Pointer(Void).null
    ...
    def has_output_port(id : Int64) : Bool
      ...
      arg_0 = pointerof(val_0).as(Void*)
      args = StaticArray[arg_0]
      godot_ptrcall_bool(@@mb_has_output_port, @pointer, args.to_unsafe.as(Void**))
    end
    # Predicate alias for `has_output_port`
    def has_output_port?(id : Int64) : Bool
      has_output_port(id)
    end
    ...
    def clear_output_ports() : Void
      ...
      godot_ptrcall_void(@@mb_clear_output_ports, @pointer, Pointer(Pointer(Void)).null)
    end
    @@mb_set_input_port_name : Void* = Pointer(Void).null
    def set_input_port_name(id : Int64, name : String) : Void
    ...
    def get_free_input_port_id() : Int64
      ...
      godot_ptrcall_int(@@mb_get_free_input_port_id, @pointer, Pointer(Pointer(Void)).null)
    end
    ...
    def get_free_output_port_id() : Int64
      ...
      godot_ptrcall_int(@@mb_get_free_output_port_id, @pointer, Pointer(Pointer(Void)).null)
    end
  end
  class VisualShaderNodeExpression < Godot::VisualShaderNodeGroupBase
    ...
    def set_expression(expression : String) : Void
      ...
      arg_0 = str_0
      args = StaticArray[arg_0]
      godot_ptrcall_void(@@mb_set_expression, @pointer, args.to_unsafe.as(Void**))
    ensure
      Bridge.free_string(str_0)
    end
  ...
  class VisualShaderNodeFloatConstant < Godot::VisualShaderNodeConstant
    ...
    def get_constant() : Float64
      ...
      godot_ptrcall_float(@@mb_get_constant, @pointer, Pointer(Pointer(Void)).null)
    end
    # Property `constant` getter
    def constant
      get_constant
  ...
  class VisualShaderNodeFloatParameter < Godot::VisualShaderNodeParameter
    ...
    def set_hint(hint : Hint | Int) : Void
      ...
      arg_0 = pointerof(val_0).as(Void*)
      args = StaticArray[arg_0]
      godot_ptrcall_void(@@mb_set_hint, @pointer, args.to_unsafe.as(Void**))
    end
    @@mb_get_hint : Void* = Pointer(Void).null
    def get_hint() : Hint
      godot_bind(@@mb_get_hint, "VisualShaderNodeFloatParameter", "get_hint", 3042240429_i64)
      godot_ptrcall_enum(@@mb_get_hint, @pointer, Pointer(Pointer(Void)).null, Hint)
    end
    ...
    def get_min() : Float64
      ...
      godot_ptrcall_float(@@mb_get_min, @pointer, Pointer(Pointer(Void)).null)
    end
    ...
    def get_max() : Float64
      ...
      godot_ptrcall_float(@@mb_get_max, @pointer, Pointer(Pointer(Void)).null)
    end
    ...
    def get_step() : Float64
      ...
      godot_ptrcall_float(@@mb_get_step, @pointer, Pointer(Pointer(Void)).null)
    end
    @@mb_set_default_value_enabled : Void* = Pointer(Void).null
    def set_default_value_enabled(enabled : Bool) : Void
    ...
    def get_default_value() : Float64
      ...
      godot_ptrcall_float(@@mb_get_default_value, @pointer, Pointer(Pointer(Void)).null)
    end
  ...
  class VisualShaderNodeGroup < Godot::VisualShaderNode
    ...
    def set_group(group : VisualShaderGroup) : Void
      ...
      arg_0 = pointerof(arg_ptr_0).as(Void*)
      args = StaticArray[arg_0]
      godot_ptrcall_void(@@mb_set_group, @pointer, args.to_unsafe.as(Void**))
    end
    ...
    def get_group() : VisualShaderGroup
      ...
      godot_ptrcall_obj(@@mb_get_group, @pointer, Pointer(Pointer(Void)).null, VisualShaderGroup)
    end
  ...
  class VisualShaderNodeInput < Godot::VisualShaderNode
    ...
    def set_input_name(name : String) : Void
      ...
      arg_0 = str_0
      args = StaticArray[arg_0]
      godot_ptrcall_void(@@mb_set_input_name, @pointer, args.to_unsafe.as(Void**))
    ensure
      Bridge.free_string(str_0)
    end
  ...
  class VisualShaderNodeIntConstant < Godot::VisualShaderNodeConstant
    ...
    def get_constant() : Int64
      ...
      godot_ptrcall_int(@@mb_get_constant, @pointer, Pointer(Pointer(Void)).null)
    end
    # Property `constant` getter
    def constant
      get_constant
  ...
  class VisualShaderNodeIntParameter < Godot::VisualShaderNodeParameter
    ...
    def get_min() : Int64
      ...
      godot_ptrcall_int(@@mb_get_min, @pointer, Pointer(Pointer(Void)).null)
    end
    @@mb_set_max : Void* = Pointer(Void).null
    ...
    def get_max() : Int64
      ...
      godot_ptrcall_int(@@mb_get_max, @pointer, Pointer(Pointer(Void)).null)
    end
    @@mb_set_step : Void* = Pointer(Void).null
    ...
    def get_step() : Int64
      ...
      godot_ptrcall_int(@@mb_get_step, @pointer, Pointer(Pointer(Void)).null)
    end
    ...
    def set_enum_names(names : Pointer(Void)) : Void
      ...
      arg_0 = pointerof(val_0).as(Void*)
      args = StaticArray[arg_0]
      godot_ptrcall_void(@@mb_set_enum_names, @pointer, args.to_unsafe.as(Void**))
    end
    ...
    def get_enum_names() : Pointer(Void)
      ...
      ret_buf = StaticArray(Pointer(Void), 2).new(Pointer(Void).null)
      godot_ptrcall(@@mb_get_enum_names, @pointer, Pointer(Pointer(Void)).null, ret_buf.to_unsafe.as(Void*))
      ret_buf[0].null? ? ret_buf[1] : ret_buf[0]
    end
    @@mb_set_default_value_enabled : Void* = Pointer(Void).null
    def set_default_value_enabled(enabled : Bool) : Void
    ...
    def get_default_value() : Int64
      ...
      godot_ptrcall_int(@@mb_get_default_value, @pointer, Pointer(Pointer(Void)).null)
    end
    # Property `hint` getter
    def hint
      get_hint
  ...
  class VisualShaderNodeParticleAccelerator < Godot::VisualShaderNode
    ...
    def get_mode() : Mode
      ...
      godot_ptrcall_enum(@@mb_get_mode, @pointer, Pointer(Pointer(Void)).null, Mode)
    end
  ...
  class VisualShaderNodeParticleEmitter < Godot::VisualShaderNode
    ...
    def set_mode_2d(enabled : Bool) : Void
      ...
      arg_0 = pointerof(val_0).as(Void*)
      args = StaticArray[arg_0]
      godot_ptrcall_void(@@mb_set_mode_2d, @pointer, args.to_unsafe.as(Void**))
    end
    @@mb_is_mode_2d : Void* = Pointer(Void).null
    def is_mode_2d() : Bool
      godot_bind(@@mb_is_mode_2d, "VisualShaderNodeParticleEmitter", "is_mode_2d", 36873697_i64)
      godot_ptrcall_bool(@@mb_is_mode_2d, @pointer, Pointer(Pointer(Void)).null)
    end
    # Predicate alias for `is_mode_2d`
    def is_mode_2d?() : Bool
      is_mode_2d()
    end
    # Predicate alias for `is_mode_2d`
  ...
  class VisualShaderNodeParticleEmit < Godot::VisualShaderNode
    ...
    def set_flags(flags : EmitFlags | Int) : Void
      ...
      arg_0 = pointerof(val_0).as(Void*)
      args = StaticArray[arg_0]
      godot_ptrcall_void(@@mb_set_flags, @pointer, args.to_unsafe.as(Void**))
    end
    ...
    def get_flags() : EmitFlags
      ...
      godot_ptrcall_enum(@@mb_get_flags, @pointer, Pointer(Pointer(Void)).null, EmitFlags)
    end
  ...
  class VisualShaderNodeParticleMeshEmitter < Godot::VisualShaderNodeParticleEmitter
    ...
    def set_mesh(mesh : Mesh) : Void
      ...
      arg_0 = pointerof(arg_ptr_0).as(Void*)
      args = StaticArray[arg_0]
      godot_ptrcall_void(@@mb_set_mesh, @pointer, args.to_unsafe.as(Void**))
    end
    @@mb_get_mesh : Void* = Pointer(Void).null
    def get_mesh() : Mesh
      godot_bind(@@mb_get_mesh, "VisualShaderNodeParticleMeshEmitter", "get_mesh", 1808005922_i64)
      godot_ptrcall_obj(@@mb_get_mesh, @pointer, Pointer(Pointer(Void)).null, Mesh)
    end
    ...
    def set_use_all_surfaces(enabled : Bool) : Void
      ...
      arg_0 = pointerof(val_0).as(Void*)
      args = StaticArray[arg_0]
      godot_ptrcall_void(@@mb_set_use_all_surfaces, @pointer, args.to_unsafe.as(Void**))
    end
    ...
    def is_use_all_surfaces() : Bool
      ...
      godot_ptrcall_bool(@@mb_is_use_all_surfaces, @pointer, Pointer(Pointer(Void)).null)
    end
    # Predicate alias for `is_use_all_surfaces`
    def is_use_all_surfaces?() : Bool
      is_use_all_surfaces()
    end
    # Predicate alias for `is_use_all_surfaces`
    def use_all_surfaces?() : Bool
      is_use_all_surfaces()
    end
    ...
    def set_surface_index(surface_index : Int64) : Void
      ...
      val_0 = surface_index.to_i64
      arg_0 = pointerof(val_0).as(Void*)
      args = StaticArray[arg_0]
      godot_ptrcall_void(@@mb_set_surface_index, @pointer, args.to_unsafe.as(Void**))
    end
    ...
    def get_surface_index() : Int64
      ...
      godot_ptrcall_int(@@mb_get_surface_index, @pointer, Pointer(Pointer(Void)).null)
    end
  ...
  class VisualShaderNodeParticleMultiplyByAxisAngle < Godot::VisualShaderNode
    ...
    def set_degrees_mode(enabled : Bool) : Void
      ...
      arg_0 = pointerof(val_0).as(Void*)
      args = StaticArray[arg_0]
      godot_ptrcall_void(@@mb_set_degrees_mode, @pointer, args.to_unsafe.as(Void**))
    end
    ...
    def is_degrees_mode() : Bool
      ...
      godot_ptrcall_bool(@@mb_is_degrees_mode, @pointer, Pointer(Pointer(Void)).null)
    end
    # Predicate alias for `is_degrees_mode`
    def is_degrees_mode?() : Bool
      is_degrees_mode()
    end
    # Predicate alias for `is_degrees_mode`
    def degrees_mode?() : Bool
      is_degrees_mode()
    end
  ...
  class VisualShaderNodeReroute < Godot::VisualShaderNode
    ...
    def get_port_type() : Godot::VisualShaderNode::PortType
      ...
      godot_ptrcall_enum(@@mb_get_port_type, @pointer, Pointer(Pointer(Void)).null, Godot::VisualShaderNode::PortType)
    end
  ...
  class VisualShaderNodeTexture < Godot::VisualShaderNode
    ...
    def get_texture() : Texture2D
      ...
      godot_ptrcall_obj(@@mb_get_texture, @pointer, Pointer(Pointer(Void)).null, Texture2D)
    end
    @@mb_set_texture_type : Void* = Pointer(Void).null
    def set_texture_type(value : TextureType | Int) : Void
  ...
  class VisualShaderNodeTexture2DArray < Godot::VisualShaderNodeSample3D
    ...
    def set_texture_array(value : TextureLayered) : Void
      ...
      arg_0 = pointerof(arg_ptr_0).as(Void*)
      args = StaticArray[arg_0]
      godot_ptrcall_void(@@mb_set_texture_array, @pointer, args.to_unsafe.as(Void**))
    end
    ...
    def get_texture_array() : TextureLayered
      ...
      godot_ptrcall_obj(@@mb_get_texture_array, @pointer, Pointer(Pointer(Void)).null, TextureLayered)
    end
  ...
  class VisualShaderNodeTexture3D < Godot::VisualShaderNodeSample3D
    ...
    def get_texture() : Texture3D
      ...
      godot_ptrcall_obj(@@mb_get_texture, @pointer, Pointer(Pointer(Void)).null, Texture3D)
    end
    # Property `texture` getter
    def texture
      get_texture
  ...
  class VisualShaderNodeTransformConstant < Godot::VisualShaderNodeConstant
    ...
    def get_constant() : Transform3D
      ...
      godot_ptrcall_val(@@mb_get_constant, @pointer, Pointer(Pointer(Void)).null, Transform3D)
    end
    # Property `constant` getter
    def constant
      get_constant
  ...
  class VisualShaderNodeTransformParameter < Godot::VisualShaderNodeParameter
    ...
    def get_default_value() : Transform3D
      ...
      godot_ptrcall_val(@@mb_get_default_value, @pointer, Pointer(Pointer(Void)).null, Transform3D)
    end
    # Property `default_value_enabled` getter
    def default_value_enabled
      is_default_value_enabled
  ...
  class VisualShaderNodeVarying < Godot::VisualShaderNode
    ...
    def set_varying_name(name : String) : Void
      ...
      arg_0 = str_0
      args = StaticArray[arg_0]
      godot_ptrcall_void(@@mb_set_varying_name, @pointer, args.to_unsafe.as(Void**))
    ensure
      Bridge.free_string(str_0)
    end
    ...
    def set_varying_type(get_type : Godot::VisualShader::VaryingType | Int) : Void
      ...
      arg_0 = pointerof(val_0).as(Void*)
      args = StaticArray[arg_0]
      godot_ptrcall_void(@@mb_set_varying_type, @pointer, args.to_unsafe.as(Void**))
    end
    ...
    def get_varying_type() : Godot::VisualShader::VaryingType
      ...
      godot_ptrcall_enum(@@mb_get_varying_type, @pointer, Pointer(Pointer(Void)).null, Godot::VisualShader::VaryingType)
    end
  ...
  class VisualShaderNodeVec2Constant < Godot::VisualShaderNodeConstant
    ...
    def get_constant() : Vector2
      ...
      godot_ptrcall_val(@@mb_get_constant, @pointer, Pointer(Pointer(Void)).null, Vector2)
    end
    # Property `constant` getter
    def constant
      get_constant
  ...
  class VisualShaderNodeVec2Parameter < Godot::VisualShaderNodeParameter
    ...
    def get_default_value() : Vector2
      ...
      godot_ptrcall_val(@@mb_get_default_value, @pointer, Pointer(Pointer(Void)).null, Vector2)
    end
    # Property `default_value_enabled` getter
    def default_value_enabled
      is_default_value_enabled
  ...
  class VisualShaderNodeVec3Constant < Godot::VisualShaderNodeConstant
    ...
    def get_constant() : Vector3
      ...
      godot_ptrcall_val(@@mb_get_constant, @pointer, Pointer(Pointer(Void)).null, Vector3)
    end
    # Property `constant` getter
    def constant
      get_constant
  ...
  class VisualShaderNodeVec3Parameter < Godot::VisualShaderNodeParameter
    ...
    def get_default_value() : Vector3
      ...
      godot_ptrcall_val(@@mb_get_default_value, @pointer, Pointer(Pointer(Void)).null, Vector3)
    end
    # Property `default_value_enabled` getter
    def default_value_enabled
      is_default_value_enabled
  ...
  class VisualShaderNodeVec4Constant < Godot::VisualShaderNodeConstant
    ...
    def get_constant() : Quaternion
      ...
      godot_ptrcall_val(@@mb_get_constant, @pointer, Pointer(Pointer(Void)).null, Quaternion)
    end
    # Property `constant` getter
    def constant
      get_constant
  ...
  class VisualShaderNodeVec4Parameter < Godot::VisualShaderNodeParameter
    ...
    def get_default_value() : Vector4
      ...
      godot_ptrcall_val(@@mb_get_default_value, @pointer, Pointer(Pointer(Void)).null, Vector4)
    end
    # Property `default_value_enabled` getter
    def default_value_enabled
      is_default_value_enabled
  ...
  class VoxelGI < Godot::VisualInstance3D
    ...
    def set_probe_data(data : VoxelGIData) : Void
      ...
      arg_0 = pointerof(arg_ptr_0).as(Void*)
      args = StaticArray[arg_0]
      godot_ptrcall_void(@@mb_set_probe_data, @pointer, args.to_unsafe.as(Void**))
    end
    ...
    def get_probe_data() : VoxelGIData
      ...
      godot_ptrcall_obj(@@mb_get_probe_data, @pointer, Pointer(Pointer(Void)).null, VoxelGIData)
    end
    ...
    def set_subdiv(subdiv : Subdiv | Int) : Void
      ...
      arg_0 = pointerof(val_0).as(Void*)
      args = StaticArray[arg_0]
      godot_ptrcall_void(@@mb_set_subdiv, @pointer, args.to_unsafe.as(Void**))
    end
    @@mb_get_subdiv : Void* = Pointer(Void).null
    def get_subdiv() : Subdiv
      godot_bind(@@mb_get_subdiv, "VoxelGI", "get_subdiv", 4261647950_i64)
      godot_ptrcall_enum(@@mb_get_subdiv, @pointer, Pointer(Pointer(Void)).null, Subdiv)
    end
    @@mb_set_size : Void* = Pointer(Void).null
    ...
    def get_size() : Vector3
      ...
      godot_ptrcall_val(@@mb_get_size, @pointer, Pointer(Pointer(Void)).null, Vector3)
    end
    ...
    def set_camera_attributes(camera_attributes : CameraAttributes) : Void
      ...
      arg_0 = pointerof(arg_ptr_0).as(Void*)
      args = StaticArray[arg_0]
      godot_ptrcall_void(@@mb_set_camera_attributes, @pointer, args.to_unsafe.as(Void**))
    end
    ...
    def get_camera_attributes() : CameraAttributes
      ...
      godot_ptrcall_obj(@@mb_get_camera_attributes, @pointer, Pointer(Pointer(Void)).null, CameraAttributes)
    end
    ...
    def bake(from_node : Node? = nil, create_visual_debug : Bool = false) : Void
      ...
      arg_1 = pointerof(val_1).as(Void*)
      args = StaticArray[arg_0, arg_1]
      godot_ptrcall_void(@@mb_bake, @pointer, args.to_unsafe.as(Void**))
    end
    @@mb_debug_bake : Void* = Pointer(Void).null
    def debug_bake() : Void
      godot_bind(@@mb_debug_bake, "VoxelGI", "debug_bake", 3218959716_i64)
      godot_ptrcall_void(@@mb_debug_bake, @pointer, Pointer(Pointer(Void)).null)
    end
  ...
  class VoxelGIData < Godot::Resource
    ...
    def godot_allocate(to_cell_xform : Transform3D, aabb : AABB, octree_size : Vector3, octree_cells : Pointer(Void), data_cells : Pointer(Void), distance_field : Pointer(Void), level_counts : Pointer(Void)) : Void
      ...
      godot_ptrcall_void(@@mb_allocate, @pointer, args.to_unsafe.as(Void**))
    end
    @@mb_get_bounds : Void* = Pointer(Void).null
    def get_bounds() : AABB
      godot_bind(@@mb_get_bounds, "VoxelGIData", "get_bounds", 1068685055_i64)
      godot_ptrcall_val(@@mb_get_bounds, @pointer, Pointer(Pointer(Void)).null, AABB)
    end
    ...
    def get_octree_size() : Vector3
      ...
      godot_ptrcall_val(@@mb_get_octree_size, @pointer, Pointer(Pointer(Void)).null, Vector3)
    end
    ...
    def get_to_cell_xform() : Transform3D
      ...
      godot_ptrcall_val(@@mb_get_to_cell_xform, @pointer, Pointer(Pointer(Void)).null, Transform3D)
    end
    ...
    def get_octree_cells() : Pointer(Void)
      ...
      ret_buf = StaticArray(Pointer(Void), 2).new(Pointer(Void).null)
      godot_ptrcall(@@mb_get_octree_cells, @pointer, Pointer(Pointer(Void)).null, ret_buf.to_unsafe.as(Void*))
      ret_buf[0].null? ? ret_buf[1] : ret_buf[0]
    end
    ...
    def get_data_cells() : Pointer(Void)
      ...
      ret_buf = StaticArray(Pointer(Void), 2).new(Pointer(Void).null)
      godot_ptrcall(@@mb_get_data_cells, @pointer, Pointer(Pointer(Void)).null, ret_buf.to_unsafe.as(Void*))
      ret_buf[0].null? ? ret_buf[1] : ret_buf[0]
    end
    ...
    def get_level_counts() : Pointer(Void)
      ...
      ret_buf = StaticArray(Pointer(Void), 2).new(Pointer(Void).null)
      godot_ptrcall(@@mb_get_level_counts, @pointer, Pointer(Pointer(Void)).null, ret_buf.to_unsafe.as(Void*))
      ret_buf[0].null? ? ret_buf[1] : ret_buf[0]
    end
    ...
    def set_dynamic_range(dynamic_range : Float64) : Void
      ...
      val_0 = dynamic_range.to_f64
      arg_0 = pointerof(val_0).as(Void*)
      args = StaticArray[arg_0]
      godot_ptrcall_void(@@mb_set_dynamic_range, @pointer, args.to_unsafe.as(Void**))
    end
    ...
    def get_dynamic_range() : Float64
      ...
      godot_ptrcall_float(@@mb_get_dynamic_range, @pointer, Pointer(Pointer(Void)).null)
    end
    ...
    def set_energy(energy : Float64) : Void
      ...
      arg_0 = pointerof(val_0).as(Void*)
      args = StaticArray[arg_0]
      godot_ptrcall_void(@@mb_set_energy, @pointer, args.to_unsafe.as(Void**))
    end
    @@mb_get_energy : Void* = Pointer(Void).null
    def get_energy() : Float64
      godot_bind(@@mb_get_energy, "VoxelGIData", "get_energy", 1740695150_i64)
      godot_ptrcall_float(@@mb_get_energy, @pointer, Pointer(Pointer(Void)).null)
    end
    ...
    def set_bias(bias : Float64) : Void
      ...
      arg_0 = pointerof(val_0).as(Void*)
      args = StaticArray[arg_0]
      godot_ptrcall_void(@@mb_set_bias, @pointer, args.to_unsafe.as(Void**))
    end
    @@mb_get_bias : Void* = Pointer(Void).null
    def get_bias() : Float64
      godot_bind(@@mb_get_bias, "VoxelGIData", "get_bias", 1740695150_i64)
      godot_ptrcall_float(@@mb_get_bias, @pointer, Pointer(Pointer(Void)).null)
    end
    ...
    def set_normal_bias(bias : Float64) : Void
      ...
      arg_0 = pointerof(val_0).as(Void*)
      args = StaticArray[arg_0]
      godot_ptrcall_void(@@mb_set_normal_bias, @pointer, args.to_unsafe.as(Void**))
    end
    ...
    def get_normal_bias() : Float64
      ...
      godot_ptrcall_float(@@mb_get_normal_bias, @pointer, Pointer(Pointer(Void)).null)
    end
    ...
    def set_propagation(propagation : Float64) : Void
      ...
      val_0 = propagation.to_f64
      arg_0 = pointerof(val_0).as(Void*)
      args = StaticArray[arg_0]
      godot_ptrcall_void(@@mb_set_propagation, @pointer, args.to_unsafe.as(Void**))
    end
    ...
    def get_propagation() : Float64
      ...
      godot_ptrcall_float(@@mb_get_propagation, @pointer, Pointer(Pointer(Void)).null)
    end
    ...
    def set_interior(interior : Bool) : Void
      ...
      arg_0 = pointerof(val_0).as(Void*)
      args = StaticArray[arg_0]
      godot_ptrcall_void(@@mb_set_interior, @pointer, args.to_unsafe.as(Void**))
    end
    @@mb_is_interior : Void* = Pointer(Void).null
    def is_interior() : Bool
      godot_bind(@@mb_is_interior, "VoxelGIData", "is_interior", 36873697_i64)
      godot_ptrcall_bool(@@mb_is_interior, @pointer, Pointer(Pointer(Void)).null)
    end
    # Predicate alias for `is_interior`
    def is_interior?() : Bool
      is_interior()
    end
    # Predicate alias for `is_interior`
    ...
    def set_use_two_bounces(enable : Bool) : Void
      ...
      arg_0 = pointerof(val_0).as(Void*)
      args = StaticArray[arg_0]
      godot_ptrcall_void(@@mb_set_use_two_bounces, @pointer, args.to_unsafe.as(Void**))
    end
    ...
    def is_using_two_bounces() : Bool
      ...
      godot_ptrcall_bool(@@mb_is_using_two_bounces, @pointer, Pointer(Pointer(Void)).null)
    end
    # Predicate alias for `is_using_two_bounces`
    def is_using_two_bounces?() : Bool
      is_using_two_bounces()
    end
    # Predicate alias for `is_using_two_bounces`
    def using_two_bounces?() : Bool
      is_using_two_bounces()
    end
  ...
  class WebRTCDataChannel < Godot::PacketPeer
    ...
    def poll() : Godot::Error
      ...
      godot_ptrcall_enum(@@mb_poll, @pointer, Pointer(Pointer(Void)).null, Godot::Error)
    end
    @@mb_close : Void* = Pointer(Void).null
    def close() : Void
      godot_bind(@@mb_close, "WebRTCDataChannel", "close", 3218959716_i64)
      godot_ptrcall_void(@@mb_close, @pointer, Pointer(Pointer(Void)).null)
    end
    ...
    def was_string_packet() : Bool
      ...
      godot_ptrcall_bool(@@mb_was_string_packet, @pointer, Pointer(Pointer(Void)).null)
    end
    # Predicate alias for `was_string_packet`
    def was_string_packet?() : Bool
      was_string_packet()
    end
    ...
    def set_write_mode(write_mode : WriteMode | Int) : Void
      ...
      arg_0 = pointerof(val_0).as(Void*)
      args = StaticArray[arg_0]
      godot_ptrcall_void(@@mb_set_write_mode, @pointer, args.to_unsafe.as(Void**))
    end
    ...
    def get_write_mode() : WriteMode
      ...
      godot_ptrcall_enum(@@mb_get_write_mode, @pointer, Pointer(Pointer(Void)).null, WriteMode)
    end
    ...
    def get_ready_state() : ChannelState
      ...
      godot_ptrcall_enum(@@mb_get_ready_state, @pointer, Pointer(Pointer(Void)).null, ChannelState)
    end
    ...
    def is_ordered() : Bool
      ...
      godot_ptrcall_bool(@@mb_is_ordered, @pointer, Pointer(Pointer(Void)).null)
    end
    # Predicate alias for `is_ordered`
    def is_ordered?() : Bool
      is_ordered()
    end
    # Predicate alias for `is_ordered`
    ...
    def get_id() : Int64
      ...
      godot_ptrcall_int(@@mb_get_id, @pointer, Pointer(Pointer(Void)).null)
    end
    ...
    def get_max_packet_life_time() : Int64
      ...
      godot_ptrcall_int(@@mb_get_max_packet_life_time, @pointer, Pointer(Pointer(Void)).null)
    end
    ...
    def get_max_retransmits() : Int64
      ...
      godot_ptrcall_int(@@mb_get_max_retransmits, @pointer, Pointer(Pointer(Void)).null)
    end
    ...
    def is_negotiated() : Bool
      ...
      godot_ptrcall_bool(@@mb_is_negotiated, @pointer, Pointer(Pointer(Void)).null)
    end
    # Predicate alias for `is_negotiated`
    def is_negotiated?() : Bool
      is_negotiated()
    end
    # Predicate alias for `is_negotiated`
    ...
    def get_buffered_amount() : Int64
      ...
      godot_ptrcall_int(@@mb_get_buffered_amount, @pointer, Pointer(Pointer(Void)).null)
    end
  ...
  class WebRTCMultiplayerPeer < Godot::MultiplayerPeer
    ...
    def create_server(channels_config : Pointer(Void)) : Godot::Error
      ...
      arg_0 = pointerof(val_0).as(Void*)
      args = StaticArray[arg_0]
      godot_ptrcall_enum(@@mb_create_server, @pointer, args.to_unsafe.as(Void**), Godot::Error)
    end
    ...
    def create_client(peer_id : Int64, channels_config : Pointer(Void)) : Godot::Error
      ...
      val_0 = peer_id.to_i64
      arg_0 = pointerof(val_0).as(Void*)
      val_1 = channels_config
      arg_1 = pointerof(val_1).as(Void*)
      args = StaticArray[arg_0, arg_1]
      godot_ptrcall_enum(@@mb_create_client, @pointer, args.to_unsafe.as(Void**), Godot::Error)
    end
    ...
    def create_mesh(peer_id : Int64, channels_config : Pointer(Void)) : Godot::Error
      ...
      arg_1 = pointerof(val_1).as(Void*)
      args = StaticArray[arg_0, arg_1]
      godot_ptrcall_enum(@@mb_create_mesh, @pointer, args.to_unsafe.as(Void**), Godot::Error)
    end
    ...
    def add_peer(peer : WebRTCPeerConnection, peer_id : Int64, unreliable_lifetime : Int64 = 1_i64) : Godot::Error
      ...
      arg_0 = pointerof(arg_ptr_0).as(Void*)
      val_1 = peer_id.to_i64
      arg_1 = pointerof(val_1).as(Void*)
      val_2 = unreliable_lifetime.to_i64
      arg_2 = pointerof(val_2).as(Void*)
      args = StaticArray[arg_0, arg_1, arg_2]
      godot_ptrcall_enum(@@mb_add_peer, @pointer, args.to_unsafe.as(Void**), Godot::Error)
    end
    ...
    def remove_peer(peer_id : Int64) : Void
      ...
      arg_0 = pointerof(val_0).as(Void*)
      args = StaticArray[arg_0]
      godot_ptrcall_void(@@mb_remove_peer, @pointer, args.to_unsafe.as(Void**))
    end
    ...
    def has_peer(peer_id : Int64) : Bool
      ...
      arg_0 = pointerof(val_0).as(Void*)
      args = StaticArray[arg_0]
      godot_ptrcall_bool(@@mb_has_peer, @pointer, args.to_unsafe.as(Void**))
    end
    # Predicate alias for `has_peer`
    def has_peer?(peer_id : Int64) : Bool
      has_peer(peer_id)
    end
  ...
  class WebRTCPeerConnection < Godot::RefCounted
    ...
    def self.set_default_extension(extension_class : String) : Void
      ...
      arg_0 = sn_0
      args = StaticArray[arg_0]
      godot_ptrcall_void(@@mb_set_default_extension, Pointer(Void).null, args.to_unsafe.as(Void**))
    ensure
      Bridge.free_string_name(sn_0)
    end
    ...
    def godot_initialize(configuration : Pointer(Void)) : Godot::Error
      ...
      arg_0 = pointerof(val_0).as(Void*)
      args = StaticArray[arg_0]
      godot_ptrcall_enum(@@mb_initialize, @pointer, args.to_unsafe.as(Void**), Godot::Error)
    end
    ...
    def create_data_channel(label : String, options : Pointer(Void)) : WebRTCDataChannel
      ...
      arg_1 = pointerof(val_1).as(Void*)
      args = StaticArray[arg_0, arg_1]
      godot_ptrcall_obj(@@mb_create_data_channel, @pointer, args.to_unsafe.as(Void**), WebRTCDataChannel)
    ensure
      Bridge.free_string(str_0)
    end
    ...
    def create_offer() : Godot::Error
      ...
      godot_ptrcall_enum(@@mb_create_offer, @pointer, Pointer(Pointer(Void)).null, Godot::Error)
    end
    ...
    def set_local_description(get_type : String, sdp : String) : Godot::Error
      ...
      arg_1 = str_1
      args = StaticArray[arg_0, arg_1]
      godot_ptrcall_enum(@@mb_set_local_description, @pointer, args.to_unsafe.as(Void**), Godot::Error)
    ensure
      Bridge.free_string(str_0)
      Bridge.free_string(str_1)
    end
    ...
    def set_remote_description(get_type : String, sdp : String) : Godot::Error
      ...
      arg_1 = str_1
      args = StaticArray[arg_0, arg_1]
      godot_ptrcall_enum(@@mb_set_remote_description, @pointer, args.to_unsafe.as(Void**), Godot::Error)
    ensure
      Bridge.free_string(str_0)
      Bridge.free_string(str_1)
    end
    ...
    def add_ice_candidate(media : String, index : Int64, name : String) : Godot::Error
      ...
      arg_2 = str_2
      args = StaticArray[arg_0, arg_1, arg_2]
      godot_ptrcall_enum(@@mb_add_ice_candidate, @pointer, args.to_unsafe.as(Void**), Godot::Error)
    ensure
      Bridge.free_string(str_0)
      Bridge.free_string(str_2)
    end
    ...
    def get_connection_state() : ConnectionState
      ...
      godot_ptrcall_enum(@@mb_get_connection_state, @pointer, Pointer(Pointer(Void)).null, ConnectionState)
    end
    ...
    def get_gathering_state() : GatheringState
      ...
      godot_ptrcall_enum(@@mb_get_gathering_state, @pointer, Pointer(Pointer(Void)).null, GatheringState)
    end
  ...
  class WebSocketMultiplayerPeer < Godot::MultiplayerPeer
    ...
    def get_peer(peer_id : Int64) : WebSocketPeer
      ...
      arg_0 = pointerof(val_0).as(Void*)
      args = StaticArray[arg_0]
      godot_ptrcall_obj(@@mb_get_peer, @pointer, args.to_unsafe.as(Void**), WebSocketPeer)
    end
    ...
    def get_peer_port(id : Int64) : Int64
      ...
      arg_0 = pointerof(val_0).as(Void*)
      args = StaticArray[arg_0]
      godot_ptrcall_int(@@mb_get_peer_port, @pointer, args.to_unsafe.as(Void**))
    end
    ...
    def get_supported_protocols() : Pointer(Void)
      ...
      ret_buf = StaticArray(Pointer(Void), 2).new(Pointer(Void).null)
      godot_ptrcall(@@mb_get_supported_protocols, @pointer, Pointer(Pointer(Void)).null, ret_buf.to_unsafe.as(Void*))
      ret_buf[0].null? ? ret_buf[1] : ret_buf[0]
    end
    ...
    def set_supported_protocols(protocols : Pointer(Void)) : Void
      ...
      arg_0 = pointerof(val_0).as(Void*)
      args = StaticArray[arg_0]
      godot_ptrcall_void(@@mb_set_supported_protocols, @pointer, args.to_unsafe.as(Void**))
    end
    ...
    def get_handshake_headers() : Pointer(Void)
      ...
      ret_buf = StaticArray(Pointer(Void), 2).new(Pointer(Void).null)
      godot_ptrcall(@@mb_get_handshake_headers, @pointer, Pointer(Pointer(Void)).null, ret_buf.to_unsafe.as(Void*))
      ret_buf[0].null? ? ret_buf[1] : ret_buf[0]
    end
    ...
    def set_handshake_headers(protocols : Pointer(Void)) : Void
      ...
      arg_0 = pointerof(val_0).as(Void*)
      args = StaticArray[arg_0]
      godot_ptrcall_void(@@mb_set_handshake_headers, @pointer, args.to_unsafe.as(Void**))
    end
    ...
    def get_inbound_buffer_size() : Int64
      ...
      godot_ptrcall_int(@@mb_get_inbound_buffer_size, @pointer, Pointer(Pointer(Void)).null)
    end
    ...
    def set_inbound_buffer_size(buffer_size : Int64) : Void
      ...
      val_0 = buffer_size.to_i64
      arg_0 = pointerof(val_0).as(Void*)
      args = StaticArray[arg_0]
      godot_ptrcall_void(@@mb_set_inbound_buffer_size, @pointer, args.to_unsafe.as(Void**))
    end
    ...
    def get_outbound_buffer_size() : Int64
      ...
      godot_ptrcall_int(@@mb_get_outbound_buffer_size, @pointer, Pointer(Pointer(Void)).null)
    end
    ...
    def set_outbound_buffer_size(buffer_size : Int64) : Void
      ...
      arg_0 = pointerof(val_0).as(Void*)
      args = StaticArray[arg_0]
      godot_ptrcall_void(@@mb_set_outbound_buffer_size, @pointer, args.to_unsafe.as(Void**))
    end
    ...
    def get_handshake_timeout() : Float64
      ...
      godot_ptrcall_float(@@mb_get_handshake_timeout, @pointer, Pointer(Pointer(Void)).null)
    end
    ...
    def set_handshake_timeout(timeout : Float64) : Void
      ...
      arg_0 = pointerof(val_0).as(Void*)
      args = StaticArray[arg_0]
      godot_ptrcall_void(@@mb_set_handshake_timeout, @pointer, args.to_unsafe.as(Void**))
    end
    ...
    def set_max_queued_packets(max_queued_packets : Int64) : Void
      ...
      val_0 = max_queued_packets.to_i64
      arg_0 = pointerof(val_0).as(Void*)
      args = StaticArray[arg_0]
      godot_ptrcall_void(@@mb_set_max_queued_packets, @pointer, args.to_unsafe.as(Void**))
    end
    ...
    def get_max_queued_packets() : Int64
      ...
      godot_ptrcall_int(@@mb_get_max_queued_packets, @pointer, Pointer(Pointer(Void)).null)
    end
  ...
  class WebSocketPeer < Godot::PacketPeer
    ...
    def connect_to_url(url : String, tls_client_options : TLSOptions? = nil) : Godot::Error
      ...
      arg_1 = pointerof(arg_ptr_1).as(Void*)
      args = StaticArray[arg_0, arg_1]
      godot_ptrcall_enum(@@mb_connect_to_url, @pointer, args.to_unsafe.as(Void**), Godot::Error)
    ensure
      Bridge.free_string(str_0)
    end
    ...
    def accept_stream(stream : StreamPeer) : Godot::Error
      ...
      arg_0 = pointerof(arg_ptr_0).as(Void*)
      args = StaticArray[arg_0]
      godot_ptrcall_enum(@@mb_accept_stream, @pointer, args.to_unsafe.as(Void**), Godot::Error)
    end
    ...
    def send(message : Pointer(Void), write_mode : WriteMode | Int = 1) : Godot::Error
      ...
      arg_1 = pointerof(val_1).as(Void*)
      args = StaticArray[arg_0, arg_1]
      godot_ptrcall_enum(@@mb_send, @pointer, args.to_unsafe.as(Void**), Godot::Error)
    end
    ...
    def send_text(message : String) : Godot::Error
      ...
      arg_0 = str_0
      args = StaticArray[arg_0]
      godot_ptrcall_enum(@@mb_send_text, @pointer, args.to_unsafe.as(Void**), Godot::Error)
    ensure
      Bridge.free_string(str_0)
    end
    @@mb_was_string_packet : Void* = Pointer(Void).null
    ...
    def poll() : Void
      ...
      godot_ptrcall_void(@@mb_poll, @pointer, Pointer(Pointer(Void)).null)
    end
    @@mb_close : Void* = Pointer(Void).null
    def close(code : Int64 = 1000_i64, reason : String = "") : Void
      ...
      arg_1 = str_1
      args = StaticArray[arg_0, arg_1]
      godot_ptrcall_void(@@mb_close, @pointer, args.to_unsafe.as(Void**))
    ensure
      Bridge.free_string(str_1)
    end
    ...
    def get_connected_port() : Int64
      ...
      godot_ptrcall_int(@@mb_get_connected_port, @pointer, Pointer(Pointer(Void)).null)
    end
    ...
    def set_no_delay(enabled : Bool) : Void
      ...
      arg_0 = pointerof(val_0).as(Void*)
      args = StaticArray[arg_0]
      godot_ptrcall_void(@@mb_set_no_delay, @pointer, args.to_unsafe.as(Void**))
    end
    ...
    def get_current_outbound_buffered_amount() : Int64
      ...
      godot_ptrcall_int(@@mb_get_current_outbound_buffered_amount, @pointer, Pointer(Pointer(Void)).null)
    end
    @@mb_get_ready_state : Void* = Pointer(Void).null
    def get_ready_state() : State
      godot_bind(@@mb_get_ready_state, "WebSocketPeer", "get_ready_state", 346482985_i64)
      godot_ptrcall_enum(@@mb_get_ready_state, @pointer, Pointer(Pointer(Void)).null, State)
    end
    ...
    def get_close_code() : Int64
      ...
      godot_ptrcall_int(@@mb_get_close_code, @pointer, Pointer(Pointer(Void)).null)
    end
    ...
    def set_heartbeat_interval(interval : Float64) : Void
      ...
      arg_0 = pointerof(val_0).as(Void*)
      args = StaticArray[arg_0]
      godot_ptrcall_void(@@mb_set_heartbeat_interval, @pointer, args.to_unsafe.as(Void**))
    end
    ...
    def get_heartbeat_interval() : Float64
      ...
      godot_ptrcall_float(@@mb_get_heartbeat_interval, @pointer, Pointer(Pointer(Void)).null)
    end
    # Property `supported_protocols` getter
    def supported_protocols
      get_supported_protocols
  ...
  class WebXRInterface < Godot::XRInterface
    ...
    def is_session_supported(session_mode : String) : Void
      ...
      arg_0 = str_0
      args = StaticArray[arg_0]
      godot_ptrcall_void(@@mb_is_session_supported, @pointer, args.to_unsafe.as(Void**))
    ensure
      Bridge.free_string(str_0)
    end
    ...
    def set_session_mode(session_mode : String) : Void
      ...
      arg_0 = str_0
      args = StaticArray[arg_0]
      godot_ptrcall_void(@@mb_set_session_mode, @pointer, args.to_unsafe.as(Void**))
    ensure
      Bridge.free_string(str_0)
    end
    ...
    def set_required_features(required_features : String) : Void
      ...
      arg_0 = str_0
      args = StaticArray[arg_0]
      godot_ptrcall_void(@@mb_set_required_features, @pointer, args.to_unsafe.as(Void**))
    ensure
      Bridge.free_string(str_0)
    end
    ...
    def set_optional_features(optional_features : String) : Void
      ...
      arg_0 = str_0
      args = StaticArray[arg_0]
      godot_ptrcall_void(@@mb_set_optional_features, @pointer, args.to_unsafe.as(Void**))
    ensure
      Bridge.free_string(str_0)
    end
    ...
    def set_requested_reference_space_types(requested_reference_space_types : String) : Void
      ...
      arg_0 = str_0
      args = StaticArray[arg_0]
      godot_ptrcall_void(@@mb_set_requested_reference_space_types, @pointer, args.to_unsafe.as(Void**))
    ensure
      Bridge.free_string(str_0)
    end
    ...
    def is_input_source_active(input_source_id : Int64) : Bool
      ...
      val_0 = input_source_id.to_i64
      arg_0 = pointerof(val_0).as(Void*)
      args = StaticArray[arg_0]
      godot_ptrcall_bool(@@mb_is_input_source_active, @pointer, args.to_unsafe.as(Void**))
    end
    # Predicate alias for `is_input_source_active`
    def is_input_source_active?(input_source_id : Int64) : Bool
      is_input_source_active(input_source_id)
    end
    # Predicate alias for `is_input_source_active`
    def input_source_active?(input_source_id : Int64) : Bool
      is_input_source_active(input_source_id)
    end
    ...
    def get_input_source_tracker(input_source_id : Int64) : XRControllerTracker
      ...
      arg_0 = pointerof(val_0).as(Void*)
      args = StaticArray[arg_0]
      godot_ptrcall_obj(@@mb_get_input_source_tracker, @pointer, args.to_unsafe.as(Void**), XRControllerTracker)
    end
    ...
    def get_input_source_target_ray_mode(input_source_id : Int64) : TargetRayMode
      ...
      arg_0 = pointerof(val_0).as(Void*)
      args = StaticArray[arg_0]
      godot_ptrcall_enum(@@mb_get_input_source_target_ray_mode, @pointer, args.to_unsafe.as(Void**), TargetRayMode)
    end
    ...
    def get_display_refresh_rate() : Float64
      ...
      godot_ptrcall_float(@@mb_get_display_refresh_rate, @pointer, Pointer(Pointer(Void)).null)
    end
  ...
  class WorkerThreadPool < Godot::Object
    ...
    def add_task(action : Pointer(Void), high_priority : Bool = false, description : String = "") : Int64
      ...
      arg_2 = str_2
      args = StaticArray[arg_0, arg_1, arg_2]
      godot_ptrcall_int(@@mb_add_task, @pointer, args.to_unsafe.as(Void**))
    ensure
      Bridge.free_string(str_2)
    end
    ...
    def is_task_completed(task_id : Int64) : Bool
      ...
      val_0 = task_id.to_i64
      arg_0 = pointerof(val_0).as(Void*)
      args = StaticArray[arg_0]
      godot_ptrcall_bool(@@mb_is_task_completed, @pointer, args.to_unsafe.as(Void**))
    end
    # Predicate alias for `is_task_completed`
    def is_task_completed?(task_id : Int64) : Bool
      is_task_completed(task_id)
    end
    # Predicate alias for `is_task_completed`
    def task_completed?(task_id : Int64) : Bool
      is_task_completed(task_id)
    end
    ...
    def wait_for_task_completion(task_id : Int64) : Godot::Error
      ...
      arg_0 = pointerof(val_0).as(Void*)
      args = StaticArray[arg_0]
      godot_ptrcall_enum(@@mb_wait_for_task_completion, @pointer, args.to_unsafe.as(Void**), Godot::Error)
    end
    ...
    def get_caller_task_id() : Int64
      ...
      godot_ptrcall_int(@@mb_get_caller_task_id, @pointer, Pointer(Pointer(Void)).null)
    end
    ...
    def add_group_task(action : Pointer(Void), elements : Int64, tasks_needed : Int64 = -1_i64, high_priority : Bool = false, description : String = "") : Int64
      ...
      val_0 = action
      arg_0 = pointerof(val_0).as(Void*)
      val_1 = elements.to_i64
      arg_1 = pointerof(val_1).as(Void*)
      val_2 = tasks_needed.to_i64
      arg_2 = pointerof(val_2).as(Void*)
      val_3 = high_priority
      arg_3 = pointerof(val_3).as(Void*)
      ...
      arg_4 = str_4
      args = StaticArray[arg_0, arg_1, arg_2, arg_3, arg_4]
      godot_ptrcall_int(@@mb_add_group_task, @pointer, args.to_unsafe.as(Void**))
    ensure
    ...
    def is_group_task_completed(group_id : Int64) : Bool
      ...
      val_0 = group_id.to_i64
      arg_0 = pointerof(val_0).as(Void*)
      args = StaticArray[arg_0]
      godot_ptrcall_bool(@@mb_is_group_task_completed, @pointer, args.to_unsafe.as(Void**))
    end
    # Predicate alias for `is_group_task_completed`
    def is_group_task_completed?(group_id : Int64) : Bool
      is_group_task_completed(group_id)
    end
    # Predicate alias for `is_group_task_completed`
    def group_task_completed?(group_id : Int64) : Bool
      is_group_task_completed(group_id)
    end
    ...
    def get_group_processed_element_count(group_id : Int64) : Int64
      ...
      arg_0 = pointerof(val_0).as(Void*)
      args = StaticArray[arg_0]
      godot_ptrcall_int(@@mb_get_group_processed_element_count, @pointer, args.to_unsafe.as(Void**))
    end
    ...
    def wait_for_group_task_completion(group_id : Int64) : Void
      ...
      arg_0 = pointerof(val_0).as(Void*)
      args = StaticArray[arg_0]
      godot_ptrcall_void(@@mb_wait_for_group_task_completion, @pointer, args.to_unsafe.as(Void**))
    end
    ...
    def get_caller_group_id() : Int64
      ...
      godot_ptrcall_int(@@mb_get_caller_group_id, @pointer, Pointer(Pointer(Void)).null)
    end
  end
  class World2D < Godot::Resource
    ...
    def get_canvas() : Int64
      ...
      godot_ptrcall_int(@@mb_get_canvas, @pointer, Pointer(Pointer(Void)).null)
    end
    ...
    def get_navigation_map() : Int64
      ...
      godot_ptrcall_int(@@mb_get_navigation_map, @pointer, Pointer(Pointer(Void)).null)
    end
    @@mb_get_space : Void* = Pointer(Void).null
    def get_space() : Int64
      godot_bind(@@mb_get_space, "World2D", "get_space", 2944877500_i64)
      godot_ptrcall_int(@@mb_get_space, @pointer, Pointer(Pointer(Void)).null)
    end
    ...
    def get_direct_space_state() : PhysicsDirectSpaceState2D
      ...
      godot_ptrcall_obj(@@mb_get_direct_space_state, @pointer, Pointer(Pointer(Void)).null, PhysicsDirectSpaceState2D)
    end
  ...
  class World3D < Godot::Resource
    ...
    def get_scenario() : Int64
      ...
      godot_ptrcall_int(@@mb_get_scenario, @pointer, Pointer(Pointer(Void)).null)
    end
    ...
    def set_environment(env : Environment) : Void
      ...
      arg_0 = pointerof(arg_ptr_0).as(Void*)
      args = StaticArray[arg_0]
      godot_ptrcall_void(@@mb_set_environment, @pointer, args.to_unsafe.as(Void**))
    end
    @@mb_get_environment : Void* = Pointer(Void).null
    def get_environment() : Environment
      godot_bind(@@mb_get_environment, "World3D", "get_environment", 3082064660_i64)
      godot_ptrcall_obj(@@mb_get_environment, @pointer, Pointer(Pointer(Void)).null, Environment)
    end
    ...
    def set_fallback_environment(env : Environment) : Void
      ...
      arg_0 = pointerof(arg_ptr_0).as(Void*)
      args = StaticArray[arg_0]
      godot_ptrcall_void(@@mb_set_fallback_environment, @pointer, args.to_unsafe.as(Void**))
    end
    ...
    def get_fallback_environment() : Environment
      ...
      godot_ptrcall_obj(@@mb_get_fallback_environment, @pointer, Pointer(Pointer(Void)).null, Environment)
    end
    @@mb_set_camera_attributes : Void* = Pointer(Void).null
    ...
    def get_direct_space_state() : PhysicsDirectSpaceState3D
      ...
      godot_ptrcall_obj(@@mb_get_direct_space_state, @pointer, Pointer(Pointer(Void)).null, PhysicsDirectSpaceState3D)
    end
  ...
  class WorldBoundaryShape2D < Godot::Shape2D
    ...
    def set_normal(normal : Vector2) : Void
      ...
      arg_0 = pointerof(val_0).as(Void*)
      args = StaticArray[arg_0]
      godot_ptrcall_void(@@mb_set_normal, @pointer, args.to_unsafe.as(Void**))
    end
    ...
    def set_distance(distance : Float64) : Void
      ...
      arg_0 = pointerof(val_0).as(Void*)
      args = StaticArray[arg_0]
      godot_ptrcall_void(@@mb_set_distance, @pointer, args.to_unsafe.as(Void**))
    end
    ...
    def get_distance() : Float64
      ...
      godot_ptrcall_float(@@mb_get_distance, @pointer, Pointer(Pointer(Void)).null)
    end
  ...
  class WorldBoundaryShape3D < Godot::Shape3D
    ...
    def set_plane(plane : Plane) : Void
      ...
      arg_0 = pointerof(val_0).as(Void*)
      args = StaticArray[arg_0]
      godot_ptrcall_void(@@mb_set_plane, @pointer, args.to_unsafe.as(Void**))
    end
    @@mb_get_plane : Void* = Pointer(Void).null
    def get_plane() : Plane
      godot_bind(@@mb_get_plane, "WorldBoundaryShape3D", "get_plane", 2753500971_i64)
      godot_ptrcall_val(@@mb_get_plane, @pointer, Pointer(Pointer(Void)).null, Plane)
    end
  ...
  class WorldEnvironment < Godot::Node
    ...
    def set_compositor(compositor : Compositor) : Void
      ...
      arg_0 = pointerof(arg_ptr_0).as(Void*)
      args = StaticArray[arg_0]
      godot_ptrcall_void(@@mb_set_compositor, @pointer, args.to_unsafe.as(Void**))
    end
    ...
    def get_compositor() : Compositor
      ...
      godot_ptrcall_obj(@@mb_get_compositor, @pointer, Pointer(Pointer(Void)).null, Compositor)
    end
    # Property `environment` getter
    def environment
      get_environment
  ...
  class X509Certificate < Godot::Resource
    ...
    def save(path : String) : Godot::Error
      ...
      arg_0 = str_0
      args = StaticArray[arg_0]
      godot_ptrcall_enum(@@mb_save, @pointer, args.to_unsafe.as(Void**), Godot::Error)
    ensure
      Bridge.free_string(str_0)
    end
    ...
    def load(path : String) : Godot::Error
      ...
      arg_0 = str_0
      args = StaticArray[arg_0]
      godot_ptrcall_enum(@@mb_load, @pointer, args.to_unsafe.as(Void**), Godot::Error)
    ensure
      Bridge.free_string(str_0)
    end
    ...
    def load_from_string(string : String) : Godot::Error
      ...
      arg_0 = str_0
      args = StaticArray[arg_0]
      godot_ptrcall_enum(@@mb_load_from_string, @pointer, args.to_unsafe.as(Void**), Godot::Error)
    ensure
      Bridge.free_string(str_0)
    end
  end
  class XMLParser < Godot::RefCounted
    ...
    def read() : Godot::Error
      ...
      godot_ptrcall_enum(@@mb_read, @pointer, Pointer(Pointer(Void)).null, Godot::Error)
    end
    ...
    def get_node_type() : NodeType
      ...
      godot_ptrcall_enum(@@mb_get_node_type, @pointer, Pointer(Pointer(Void)).null, NodeType)
    end
    ...
    def get_node_offset() : Int64
      ...
      godot_ptrcall_int(@@mb_get_node_offset, @pointer, Pointer(Pointer(Void)).null)
    end
    ...
    def get_attribute_count() : Int64
      ...
      godot_ptrcall_int(@@mb_get_attribute_count, @pointer, Pointer(Pointer(Void)).null)
    end
    ...
    def has_attribute(name : String) : Bool
      ...
      arg_0 = str_0
      args = StaticArray[arg_0]
      godot_ptrcall_bool(@@mb_has_attribute, @pointer, args.to_unsafe.as(Void**))
    ensure
      Bridge.free_string(str_0)
    end
    # Predicate alias for `has_attribute`
    def has_attribute?(name : String) : Bool
      has_attribute(name)
    end
    ...
    def is_empty() : Bool
      ...
      godot_ptrcall_bool(@@mb_is_empty, @pointer, Pointer(Pointer(Void)).null)
    end
    # Predicate alias for `is_empty`
    def is_empty?() : Bool
      is_empty()
    end
    # Predicate alias for `is_empty`
    ...
    def get_current_line() : Int64
      ...
      godot_ptrcall_int(@@mb_get_current_line, @pointer, Pointer(Pointer(Void)).null)
    end
    ...
    def skip_section() : Void
      ...
      godot_ptrcall_void(@@mb_skip_section, @pointer, Pointer(Pointer(Void)).null)
    end
    @@mb_seek : Void* = Pointer(Void).null
    def seek(position : Int64) : Godot::Error
      godot_bind(@@mb_seek, "XMLParser", "seek", 844576869_i64)
      val_0 = position.to_i64
      arg_0 = pointerof(val_0).as(Void*)
      args = StaticArray[arg_0]
      godot_ptrcall_enum(@@mb_seek, @pointer, args.to_unsafe.as(Void**), Godot::Error)
    end
    ...
    def open(file : String) : Godot::Error
      ...
      arg_0 = str_0
      args = StaticArray[arg_0]
      godot_ptrcall_enum(@@mb_open, @pointer, args.to_unsafe.as(Void**), Godot::Error)
    ensure
      Bridge.free_string(str_0)
    end
    ...
    def open_buffer(buffer : Pointer(Void)) : Godot::Error
      ...
      arg_0 = pointerof(val_0).as(Void*)
      args = StaticArray[arg_0]
      godot_ptrcall_enum(@@mb_open_buffer, @pointer, args.to_unsafe.as(Void**), Godot::Error)
    end
  end
  class XRNode3D < Godot::Node3D
    ...
    def set_tracker(tracker_name : String) : Void
      ...
      arg_0 = sn_0
      args = StaticArray[arg_0]
      godot_ptrcall_void(@@mb_set_tracker, @pointer, args.to_unsafe.as(Void**))
    ensure
      Bridge.free_string_name(sn_0)
    end
    ...
    def set_pose_name(pose : String) : Void
      ...
      arg_0 = sn_0
      args = StaticArray[arg_0]
      godot_ptrcall_void(@@mb_set_pose_name, @pointer, args.to_unsafe.as(Void**))
    ensure
      Bridge.free_string_name(sn_0)
    end
    ...
    def set_show_when_tracked(show : Bool) : Void
      ...
      arg_0 = pointerof(val_0).as(Void*)
      args = StaticArray[arg_0]
      godot_ptrcall_void(@@mb_set_show_when_tracked, @pointer, args.to_unsafe.as(Void**))
    end
    ...
    def get_show_when_tracked() : Bool
      ...
      godot_ptrcall_bool(@@mb_get_show_when_tracked, @pointer, Pointer(Pointer(Void)).null)
    end
    # Predicate alias for `get_show_when_tracked`
    def get_show_when_tracked?() : Bool
    ...
    def get_is_active() : Bool
      ...
      godot_ptrcall_bool(@@mb_get_is_active, @pointer, Pointer(Pointer(Void)).null)
    end
    # Predicate alias for `get_is_active`
    def get_is_active?() : Bool
      get_is_active()
    end
    ...
    def get_has_tracking_data() : Bool
      ...
      godot_ptrcall_bool(@@mb_get_has_tracking_data, @pointer, Pointer(Pointer(Void)).null)
    end
    # Predicate alias for `get_has_tracking_data`
    def get_has_tracking_data?() : Bool
    ...
    def get_pose() : XRPose
      ...
      godot_ptrcall_obj(@@mb_get_pose, @pointer, Pointer(Pointer(Void)).null, XRPose)
    end
    ...
    def trigger_haptic_pulse(action_name : String, frequency : Float64, amplitude : Float64, duration_sec : Float64, delay_sec : Float64) : Void
      ...
      arg_0 = str_0
      val_1 = frequency.to_f64
      arg_1 = pointerof(val_1).as(Void*)
      val_2 = amplitude.to_f64
      arg_2 = pointerof(val_2).as(Void*)
      val_3 = duration_sec.to_f64
      arg_3 = pointerof(val_3).as(Void*)
      val_4 = delay_sec.to_f64
      arg_4 = pointerof(val_4).as(Void*)
      args = StaticArray[arg_0, arg_1, arg_2, arg_3, arg_4]
      godot_ptrcall_void(@@mb_trigger_haptic_pulse, @pointer, args.to_unsafe.as(Void**))
    ensure
      Bridge.free_string(str_0)
    end
  ...
  class XRBodyModifier3D < Godot::SkeletonModifier3D
    ...
    def set_body_tracker(tracker_name : String) : Void
      ...
      arg_0 = sn_0
      args = StaticArray[arg_0]
      godot_ptrcall_void(@@mb_set_body_tracker, @pointer, args.to_unsafe.as(Void**))
    ensure
      Bridge.free_string_name(sn_0)
    end
    ...
    def set_body_update(body_update : BodyUpdate | Int) : Void
      ...
      arg_0 = pointerof(val_0).as(Void*)
      args = StaticArray[arg_0]
      godot_ptrcall_void(@@mb_set_body_update, @pointer, args.to_unsafe.as(Void**))
    end
    ...
    def get_body_update() : BodyUpdate
      ...
      godot_ptrcall_enum(@@mb_get_body_update, @pointer, Pointer(Pointer(Void)).null, BodyUpdate)
    end
    ...
    def set_bone_update(bone_update : BoneUpdate | Int) : Void
      ...
      arg_0 = pointerof(val_0).as(Void*)
      args = StaticArray[arg_0]
      godot_ptrcall_void(@@mb_set_bone_update, @pointer, args.to_unsafe.as(Void**))
    end
    ...
    def get_bone_update() : BoneUpdate
      ...
      godot_ptrcall_enum(@@mb_get_bone_update, @pointer, Pointer(Pointer(Void)).null, BoneUpdate)
    end
  ...
  class XRBodyTracker < Godot::XRPositionalTracker
    ...
    def set_has_tracking_data(has_data : Bool) : Void
      ...
      arg_0 = pointerof(val_0).as(Void*)
      args = StaticArray[arg_0]
      godot_ptrcall_void(@@mb_set_has_tracking_data, @pointer, args.to_unsafe.as(Void**))
    end
    @@mb_get_has_tracking_data : Void* = Pointer(Void).null
    def get_has_tracking_data() : Bool
    ...
    def set_body_flags(flags : BodyFlags | Int) : Void
      ...
      arg_0 = pointerof(val_0).as(Void*)
      args = StaticArray[arg_0]
      godot_ptrcall_void(@@mb_set_body_flags, @pointer, args.to_unsafe.as(Void**))
    end
    ...
    def get_body_flags() : BodyFlags
      ...
      godot_ptrcall_enum(@@mb_get_body_flags, @pointer, Pointer(Pointer(Void)).null, BodyFlags)
    end
    ...
    def set_joint_flags(joint : Joint | Int, flags : JointFlags | Int) : Void
      ...
      arg_1 = pointerof(val_1).as(Void*)
      args = StaticArray[arg_0, arg_1]
      godot_ptrcall_void(@@mb_set_joint_flags, @pointer, args.to_unsafe.as(Void**))
    end
    ...
    def get_joint_flags(joint : Joint | Int) : JointFlags
      ...
      arg_0 = pointerof(val_0).as(Void*)
      args = StaticArray[arg_0]
      godot_ptrcall_enum(@@mb_get_joint_flags, @pointer, args.to_unsafe.as(Void**), JointFlags)
    end
    ...
    def set_joint_transform(joint : Joint | Int, transform : Transform3D) : Void
      ...
      arg_1 = pointerof(val_1).as(Void*)
      args = StaticArray[arg_0, arg_1]
      godot_ptrcall_void(@@mb_set_joint_transform, @pointer, args.to_unsafe.as(Void**))
    end
    ...
    def get_joint_transform(joint : Joint | Int) : Transform3D
      ...
      arg_0 = pointerof(val_0).as(Void*)
      args = StaticArray[arg_0]
      godot_ptrcall_val(@@mb_get_joint_transform, @pointer, args.to_unsafe.as(Void**), Transform3D)
    end
  ...
  class XRController3D < Godot::XRNode3D
    ...
    def is_button_pressed(name : String) : Bool
      ...
      arg_0 = sn_0
      args = StaticArray[arg_0]
      godot_ptrcall_bool(@@mb_is_button_pressed, @pointer, args.to_unsafe.as(Void**))
    ensure
      Bridge.free_string_name(sn_0)
    end
    # Predicate alias for `is_button_pressed`
    def is_button_pressed?(name : String) : Bool
      is_button_pressed(name)
    end
    # Predicate alias for `is_button_pressed`
    def button_pressed?(name : String) : Bool
      is_button_pressed(name)
    end
    ...
    def get_float(name : String) : Float64
      ...
      arg_0 = sn_0
      args = StaticArray[arg_0]
      godot_ptrcall_float(@@mb_get_float, @pointer, args.to_unsafe.as(Void**))
    ensure
      Bridge.free_string_name(sn_0)
    end
    ...
    def get_vector2(name : String) : Vector2
      ...
      arg_0 = sn_0
      args = StaticArray[arg_0]
      godot_ptrcall_val(@@mb_get_vector2, @pointer, args.to_unsafe.as(Void**), Vector2)
    ensure
      Bridge.free_string_name(sn_0)
    end
  ...
  class XRFaceModifier3D < Godot::Node3D
    ...
    def set_face_tracker(tracker_name : String) : Void
      ...
      arg_0 = sn_0
      args = StaticArray[arg_0]
      godot_ptrcall_void(@@mb_set_face_tracker, @pointer, args.to_unsafe.as(Void**))
    ensure
      Bridge.free_string_name(sn_0)
    end
    ...
    def set_target(target : NodePath | String) : Void
      ...
      arg_0 = np_0
      args = StaticArray[arg_0]
      godot_ptrcall_void(@@mb_set_target, @pointer, args.to_unsafe.as(Void**))
    ensure
      Bridge.free_nodepath(np_0)
    end
  ...
  class XRFaceTracker < Godot::XRTracker
    ...
    def get_blend_shape(blend_shape : BlendShapeEntry | Int) : Float64
      ...
      arg_0 = pointerof(val_0).as(Void*)
      args = StaticArray[arg_0]
      godot_ptrcall_float(@@mb_get_blend_shape, @pointer, args.to_unsafe.as(Void**))
    end
    ...
    def set_blend_shape(blend_shape : BlendShapeEntry | Int, weight : Float64) : Void
      ...
      arg_1 = pointerof(val_1).as(Void*)
      args = StaticArray[arg_0, arg_1]
      godot_ptrcall_void(@@mb_set_blend_shape, @pointer, args.to_unsafe.as(Void**))
    end
    ...
    def get_blend_shapes() : Pointer(Void)
      ...
      ret_buf = StaticArray(Pointer(Void), 2).new(Pointer(Void).null)
      godot_ptrcall(@@mb_get_blend_shapes, @pointer, Pointer(Pointer(Void)).null, ret_buf.to_unsafe.as(Void*))
      ret_buf[0].null? ? ret_buf[1] : ret_buf[0]
    end
    ...
    def set_blend_shapes(weights : Pointer(Void)) : Void
      ...
      arg_0 = pointerof(val_0).as(Void*)
      args = StaticArray[arg_0]
      godot_ptrcall_void(@@mb_set_blend_shapes, @pointer, args.to_unsafe.as(Void**))
    end
  ...
  class XRHandModifier3D < Godot::SkeletonModifier3D
    ...
    def set_hand_tracker(tracker_name : String) : Void
      ...
      arg_0 = sn_0
      args = StaticArray[arg_0]
      godot_ptrcall_void(@@mb_set_hand_tracker, @pointer, args.to_unsafe.as(Void**))
    ensure
      Bridge.free_string_name(sn_0)
    end
  ...
  class XRHandTracker < Godot::XRPositionalTracker
    ...
    def set_hand_tracking_source(source : HandTrackingSource | Int) : Void
      ...
      arg_0 = pointerof(val_0).as(Void*)
      args = StaticArray[arg_0]
      godot_ptrcall_void(@@mb_set_hand_tracking_source, @pointer, args.to_unsafe.as(Void**))
    end
    ...
    def get_hand_tracking_source() : HandTrackingSource
      ...
      godot_ptrcall_enum(@@mb_get_hand_tracking_source, @pointer, Pointer(Pointer(Void)).null, HandTrackingSource)
    end
    ...
    def set_hand_joint_flags(joint : HandJoint | Int, flags : HandJointFlags | Int) : Void
      ...
      arg_1 = pointerof(val_1).as(Void*)
      args = StaticArray[arg_0, arg_1]
      godot_ptrcall_void(@@mb_set_hand_joint_flags, @pointer, args.to_unsafe.as(Void**))
    end
    ...
    def get_hand_joint_flags(joint : HandJoint | Int) : HandJointFlags
      ...
      arg_0 = pointerof(val_0).as(Void*)
      args = StaticArray[arg_0]
      godot_ptrcall_enum(@@mb_get_hand_joint_flags, @pointer, args.to_unsafe.as(Void**), HandJointFlags)
    end
    ...
    def set_hand_joint_transform(joint : HandJoint | Int, transform : Transform3D) : Void
      ...
      arg_1 = pointerof(val_1).as(Void*)
      args = StaticArray[arg_0, arg_1]
      godot_ptrcall_void(@@mb_set_hand_joint_transform, @pointer, args.to_unsafe.as(Void**))
    end
    ...
    def get_hand_joint_transform(joint : HandJoint | Int) : Transform3D
      ...
      arg_0 = pointerof(val_0).as(Void*)
      args = StaticArray[arg_0]
      godot_ptrcall_val(@@mb_get_hand_joint_transform, @pointer, args.to_unsafe.as(Void**), Transform3D)
    end
    ...
    def set_hand_joint_radius(joint : HandJoint | Int, radius : Float64) : Void
      ...
      arg_1 = pointerof(val_1).as(Void*)
      args = StaticArray[arg_0, arg_1]
      godot_ptrcall_void(@@mb_set_hand_joint_radius, @pointer, args.to_unsafe.as(Void**))
    end
    ...
    def get_hand_joint_radius(joint : HandJoint | Int) : Float64
      ...
      arg_0 = pointerof(val_0).as(Void*)
      args = StaticArray[arg_0]
      godot_ptrcall_float(@@mb_get_hand_joint_radius, @pointer, args.to_unsafe.as(Void**))
    end
    ...
    def set_hand_joint_linear_velocity(joint : HandJoint | Int, linear_velocity : Vector3) : Void
      ...
      arg_1 = pointerof(val_1).as(Void*)
      args = StaticArray[arg_0, arg_1]
      godot_ptrcall_void(@@mb_set_hand_joint_linear_velocity, @pointer, args.to_unsafe.as(Void**))
    end
    ...
    def get_hand_joint_linear_velocity(joint : HandJoint | Int) : Vector3
      ...
      arg_0 = pointerof(val_0).as(Void*)
      args = StaticArray[arg_0]
      godot_ptrcall_val(@@mb_get_hand_joint_linear_velocity, @pointer, args.to_unsafe.as(Void**), Vector3)
    end
    ...
    def set_hand_joint_angular_velocity(joint : HandJoint | Int, angular_velocity : Vector3) : Void
      ...
      arg_1 = pointerof(val_1).as(Void*)
      args = StaticArray[arg_0, arg_1]
      godot_ptrcall_void(@@mb_set_hand_joint_angular_velocity, @pointer, args.to_unsafe.as(Void**))
    end
    ...
    def get_hand_joint_angular_velocity(joint : HandJoint | Int) : Vector3
      ...
      arg_0 = pointerof(val_0).as(Void*)
      args = StaticArray[arg_0]
      godot_ptrcall_val(@@mb_get_hand_joint_angular_velocity, @pointer, args.to_unsafe.as(Void**), Vector3)
    end
    # Property `has_tracking_data` getter
    def has_tracking_data
      get_has_tracking_data
  ...
  class XRInterfaceExtension < Godot::XRInterface
    ...
    def get_color_texture() : Int64
      ...
      godot_ptrcall_int(@@mb_get_color_texture, @pointer, Pointer(Pointer(Void)).null)
    end
    ...
    def get_depth_texture() : Int64
      ...
      godot_ptrcall_int(@@mb_get_depth_texture, @pointer, Pointer(Pointer(Void)).null)
    end
    ...
    def get_velocity_texture() : Int64
      ...
      godot_ptrcall_int(@@mb_get_velocity_texture, @pointer, Pointer(Pointer(Void)).null)
    end
    ...
    def get_render_target_texture(render_target : Int64) : Int64
      ...
      arg_0 = pointerof(val_0).as(Void*)
      args = StaticArray[arg_0]
      godot_ptrcall_int(@@mb_get_render_target_texture, @pointer, args.to_unsafe.as(Void**))
    end
  end
  class XROrigin3D < Godot::Node3D
    ...
    def set_world_scale(world_scale : Float64) : Void
      ...
      val_0 = world_scale.to_f64
      arg_0 = pointerof(val_0).as(Void*)
      args = StaticArray[arg_0]
      godot_ptrcall_void(@@mb_set_world_scale, @pointer, args.to_unsafe.as(Void**))
    end
    ...
    def get_world_scale() : Float64
      ...
      godot_ptrcall_float(@@mb_get_world_scale, @pointer, Pointer(Pointer(Void)).null)
    end
    ...
    def set_current(enabled : Bool) : Void
      ...
      arg_0 = pointerof(val_0).as(Void*)
      args = StaticArray[arg_0]
      godot_ptrcall_void(@@mb_set_current, @pointer, args.to_unsafe.as(Void**))
    end
  ...
  class XRPose < Godot::RefCounted
    ...
    def set_name(name : String) : Void
      ...
      arg_0 = sn_0
      args = StaticArray[arg_0]
      godot_ptrcall_void(@@mb_set_name, @pointer, args.to_unsafe.as(Void**))
    ensure
      Bridge.free_string_name(sn_0)
    end
    ...
    def set_transform(transform : Transform3D) : Void
      ...
      arg_0 = pointerof(val_0).as(Void*)
      args = StaticArray[arg_0]
      godot_ptrcall_void(@@mb_set_transform, @pointer, args.to_unsafe.as(Void**))
    end
    ...
    def get_transform() : Transform3D
      ...
      godot_ptrcall_val(@@mb_get_transform, @pointer, Pointer(Pointer(Void)).null, Transform3D)
    end
    ...
    def get_adjusted_transform() : Transform3D
      ...
      godot_ptrcall_val(@@mb_get_adjusted_transform, @pointer, Pointer(Pointer(Void)).null, Transform3D)
    end
    ...
    def set_linear_velocity(velocity : Vector3) : Void
      ...
      arg_0 = pointerof(val_0).as(Void*)
      args = StaticArray[arg_0]
      godot_ptrcall_void(@@mb_set_linear_velocity, @pointer, args.to_unsafe.as(Void**))
    end
    ...
    def get_linear_velocity() : Vector3
      ...
      godot_ptrcall_val(@@mb_get_linear_velocity, @pointer, Pointer(Pointer(Void)).null, Vector3)
    end
    ...
    def set_angular_velocity(velocity : Vector3) : Void
      ...
      arg_0 = pointerof(val_0).as(Void*)
      args = StaticArray[arg_0]
      godot_ptrcall_void(@@mb_set_angular_velocity, @pointer, args.to_unsafe.as(Void**))
    end
    ...
    def get_angular_velocity() : Vector3
      ...
      godot_ptrcall_val(@@mb_get_angular_velocity, @pointer, Pointer(Pointer(Void)).null, Vector3)
    end
    ...
    def set_tracking_confidence(tracking_confidence : TrackingConfidence | Int) : Void
      ...
      arg_0 = pointerof(val_0).as(Void*)
      args = StaticArray[arg_0]
      godot_ptrcall_void(@@mb_set_tracking_confidence, @pointer, args.to_unsafe.as(Void**))
    end
    ...
    def get_tracking_confidence() : TrackingConfidence
      ...
      godot_ptrcall_enum(@@mb_get_tracking_confidence, @pointer, Pointer(Pointer(Void)).null, TrackingConfidence)
    end
    # Property `has_tracking_data` getter
    def has_tracking_data
      get_has_tracking_data
  ...
  class XRServer < Godot::Object
    ...
    def get_world_origin() : Transform3D
      ...
      godot_ptrcall_val(@@mb_get_world_origin, @pointer, Pointer(Pointer(Void)).null, Transform3D)
    end
    ...
    def set_world_origin(world_origin : Transform3D) : Void
      ...
      arg_0 = pointerof(val_0).as(Void*)
      args = StaticArray[arg_0]
      godot_ptrcall_void(@@mb_set_world_origin, @pointer, args.to_unsafe.as(Void**))
    end
    ...
    def get_reference_frame() : Transform3D
      ...
      godot_ptrcall_val(@@mb_get_reference_frame, @pointer, Pointer(Pointer(Void)).null, Transform3D)
    end
    ...
    def clear_reference_frame() : Void
      ...
      godot_ptrcall_void(@@mb_clear_reference_frame, @pointer, Pointer(Pointer(Void)).null)
    end
    ...
    def center_on_hmd(rotation_mode : RotationMode | Int, keep_height : Bool) : Void
      ...
      arg_1 = pointerof(val_1).as(Void*)
      args = StaticArray[arg_0, arg_1]
      godot_ptrcall_void(@@mb_center_on_hmd, @pointer, args.to_unsafe.as(Void**))
    end
    ...
    def get_hmd_transform() : Transform3D
      ...
      godot_ptrcall_val(@@mb_get_hmd_transform, @pointer, Pointer(Pointer(Void)).null, Transform3D)
    end
    ...
    def set_camera_locked_to_origin(enabled : Bool) : Void
      ...
      arg_0 = pointerof(val_0).as(Void*)
      args = StaticArray[arg_0]
      godot_ptrcall_void(@@mb_set_camera_locked_to_origin, @pointer, args.to_unsafe.as(Void**))
    end
    ...
    def is_camera_locked_to_origin() : Bool
      ...
      godot_ptrcall_bool(@@mb_is_camera_locked_to_origin, @pointer, Pointer(Pointer(Void)).null)
    end
    # Predicate alias for `is_camera_locked_to_origin`
    def is_camera_locked_to_origin?() : Bool
      is_camera_locked_to_origin()
    end
    # Predicate alias for `is_camera_locked_to_origin`
    def camera_locked_to_origin?() : Bool
      is_camera_locked_to_origin()
    end
    ...
    def add_interface(interface : XRInterface) : Void
      ...
      arg_0 = pointerof(arg_ptr_0).as(Void*)
      args = StaticArray[arg_0]
      godot_ptrcall_void(@@mb_add_interface, @pointer, args.to_unsafe.as(Void**))
    end
    ...
    def get_interface_count() : Int64
      ...
      godot_ptrcall_int(@@mb_get_interface_count, @pointer, Pointer(Pointer(Void)).null)
    end
    ...
    def remove_interface(interface : XRInterface) : Void
      ...
      arg_0 = pointerof(arg_ptr_0).as(Void*)
      args = StaticArray[arg_0]
      godot_ptrcall_void(@@mb_remove_interface, @pointer, args.to_unsafe.as(Void**))
    end
    ...
    def get_interface(idx : Int64) : XRInterface
      ...
      arg_0 = pointerof(val_0).as(Void*)
      args = StaticArray[arg_0]
      godot_ptrcall_obj(@@mb_get_interface, @pointer, args.to_unsafe.as(Void**), XRInterface)
    end
    ...
    def find_interface(name : String) : XRInterface
      ...
      arg_0 = str_0
      args = StaticArray[arg_0]
      godot_ptrcall_obj(@@mb_find_interface, @pointer, args.to_unsafe.as(Void**), XRInterface)
    ensure
      Bridge.free_string(str_0)
    end
    ...
    def add_tracker(tracker : XRTracker) : Void
      ...
      arg_0 = pointerof(arg_ptr_0).as(Void*)
      args = StaticArray[arg_0]
      godot_ptrcall_void(@@mb_add_tracker, @pointer, args.to_unsafe.as(Void**))
    end
    ...
    def remove_tracker(tracker : XRTracker) : Void
      ...
      arg_0 = pointerof(arg_ptr_0).as(Void*)
      args = StaticArray[arg_0]
      godot_ptrcall_void(@@mb_remove_tracker, @pointer, args.to_unsafe.as(Void**))
    end
    ...
    def get_tracker(tracker_name : String) : XRTracker
      ...
      arg_0 = sn_0
      args = StaticArray[arg_0]
      godot_ptrcall_obj(@@mb_get_tracker, @pointer, args.to_unsafe.as(Void**), XRTracker)
    ensure
      Bridge.free_string_name(sn_0)
    end
    ...
    def get_primary_interface() : XRInterface
      ...
      godot_ptrcall_obj(@@mb_get_primary_interface, @pointer, Pointer(Pointer(Void)).null, XRInterface)
    end
    ...
    def set_primary_interface(interface : XRInterface) : Void
      ...
      arg_0 = pointerof(arg_ptr_0).as(Void*)
      args = StaticArray[arg_0]
      godot_ptrcall_void(@@mb_set_primary_interface, @pointer, args.to_unsafe.as(Void**))
    end
    # Property `world_scale` getter
    def world_scale
      get_world_scale
  ...
  class XRVRS < Godot::Object
    ...
    def get_vrs_min_radius() : Float64
      ...
      godot_ptrcall_float(@@mb_get_vrs_min_radius, @pointer, Pointer(Pointer(Void)).null)
    end
    ...
    def set_vrs_min_radius(radius : Float64) : Void
      ...
      arg_0 = pointerof(val_0).as(Void*)
      args = StaticArray[arg_0]
      godot_ptrcall_void(@@mb_set_vrs_min_radius, @pointer, args.to_unsafe.as(Void**))
    end
    ...
    def get_vrs_strength() : Float64
      ...
      godot_ptrcall_float(@@mb_get_vrs_strength, @pointer, Pointer(Pointer(Void)).null)
    end
    ...
    def set_vrs_strength(strength : Float64) : Void
      ...
      arg_0 = pointerof(val_0).as(Void*)
      args = StaticArray[arg_0]
      godot_ptrcall_void(@@mb_set_vrs_strength, @pointer, args.to_unsafe.as(Void**))
    end
    ...
    def get_vrs_render_region() : Rect2i
      ...
      godot_ptrcall_val(@@mb_get_vrs_render_region, @pointer, Pointer(Pointer(Void)).null, Rect2i)
    end
    ...
    def set_vrs_render_region(render_region : Rect2i) : Void
      ...
      arg_0 = pointerof(val_0).as(Void*)
      args = StaticArray[arg_0]
      godot_ptrcall_void(@@mb_set_vrs_render_region, @pointer, args.to_unsafe.as(Void**))
    end
    ...
    def make_vrs_texture(target_size : Vector2, eye_foci : Pointer(Void)) : Int64
      ...
      arg_1 = pointerof(val_1).as(Void*)
      args = StaticArray[arg_0, arg_1]
      godot_ptrcall_int(@@mb_make_vrs_texture, @pointer, args.to_unsafe.as(Void**))
    end
  ...
  class ZIPPacker < Godot::RefCounted
    ...
    def set_compression_level(compression_level : Int64) : Void
      ...
      val_0 = compression_level.to_i64
      arg_0 = pointerof(val_0).as(Void*)
      args = StaticArray[arg_0]
      godot_ptrcall_void(@@mb_set_compression_level, @pointer, args.to_unsafe.as(Void**))
    end
    ...
    def get_compression_level() : Int64
      ...
      godot_ptrcall_int(@@mb_get_compression_level, @pointer, Pointer(Pointer(Void)).null)
    end
    ...
    def add_directory(path : String, permissions : Godot::FileAccess::UnixPermissionFlags | Int = 493, modified_time : Int64 = 0_i64) : Godot::Error
      ...
      arg_1 = pointerof(val_1).as(Void*)
      val_2 = modified_time.to_i64
      arg_2 = pointerof(val_2).as(Void*)
      args = StaticArray[arg_0, arg_1, arg_2]
      godot_ptrcall_enum(@@mb_add_directory, @pointer, args.to_unsafe.as(Void**), Godot::Error)
    ensure
      Bridge.free_string(str_0)
    end
    ...
    def start_file(path : String, permissions : Godot::FileAccess::UnixPermissionFlags | Int = 420, modified_time : Int64 = 0_i64) : Godot::Error
      ...
      arg_2 = pointerof(val_2).as(Void*)
      args = StaticArray[arg_0, arg_1, arg_2]
      godot_ptrcall_enum(@@mb_start_file, @pointer, args.to_unsafe.as(Void**), Godot::Error)
    ensure
      Bridge.free_string(str_0)
    end
    ...
    def write_file(data : Pointer(Void)) : Godot::Error
      ...
      arg_0 = pointerof(val_0).as(Void*)
      args = StaticArray[arg_0]
      godot_ptrcall_enum(@@mb_write_file, @pointer, args.to_unsafe.as(Void**), Godot::Error)
    end
    ...
    def close_file() : Godot::Error
      ...
      godot_ptrcall_enum(@@mb_close_file, @pointer, Pointer(Pointer(Void)).null, Godot::Error)
    end
    @@mb_close : Void* = Pointer(Void).null
    def close() : Godot::Error
      godot_bind(@@mb_close, "ZIPPacker", "close", 166280745_i64)
      godot_ptrcall_enum(@@mb_close, @pointer, Pointer(Pointer(Void)).null, Godot::Error)
    end
  ...
  class ZIPReader < Godot::RefCounted
    ...
    def get_files() : Pointer(Void)
      ...
      ret_buf = StaticArray(Pointer(Void), 2).new(Pointer(Void).null)
      godot_ptrcall(@@mb_get_files, @pointer, Pointer(Pointer(Void)).null, ret_buf.to_unsafe.as(Void*))
      ret_buf[0].null? ? ret_buf[1] : ret_buf[0]
    end
    ...
    def read_file(path : String, case_sensitive : Bool = true) : Pointer(Void)
      ...
      args = StaticArray[arg_0, arg_1]
      ret_buf = StaticArray(Pointer(Void), 2).new(Pointer(Void).null)
      godot_ptrcall(@@mb_read_file, @pointer, args.to_unsafe.as(Void**), ret_buf.to_unsafe.as(Void*))
      ret_buf[0].null? ? ret_buf[1] : ret_buf[0]
    ensure
      Bridge.free_string(str_0)
    end
    ...
    def file_exists(path : String, case_sensitive : Bool = true) : Bool
      ...
      arg_1 = pointerof(val_1).as(Void*)
      args = StaticArray[arg_0, arg_1]
      godot_ptrcall_bool(@@mb_file_exists, @pointer, args.to_unsafe.as(Void**))
    ensure
      Bridge.free_string(str_0)
    end
    # Predicate alias for `file_exists`
    def file_exists?(path : String, case_sensitive : Bool = true) : Bool
      file_exists(path, case_sensitive)
    end
    @@mb_get_compression_level : Void* = Pointer(Void).null
    def get_compression_level(path : String, case_sensitive : Bool = true) : Int64
      ...
      arg_1 = pointerof(val_1).as(Void*)
      args = StaticArray[arg_0, arg_1]
      godot_ptrcall_int(@@mb_get_compression_level, @pointer, args.to_unsafe.as(Void**))
    ensure
      Bridge.free_string(str_0)
    end
  end

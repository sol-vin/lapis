...
test_tween "Fluent Tween creation, transition/ease configuration, and control methods" do
  ...
  TestFramework.assert_not_nil tween
  TestFramework.assert_false tween.pointer.null?
  ...
  TestFramework.assert_not_nil int_tweener

  # Control methods
  TestFramework.assert_true tween.is_running
  tween.pause
  TestFramework.assert_false tween.is_running
  tween.play
  TestFramework.assert_true tween.is_running
  tween.kill
  TestFramework.assert_false tween.is_valid
...
test_tween "AnimationPlayer, AnimationLibrary and programmatic track authoring" do
  ...
  TestFramework.assert_approx_eq anim.get_length.to_f32, 3.0_f32
  ...
  TestFramework.assert_eq track_idx, 0_i64

  anim.track_set_path(0_i64, Godot::NodePath.new("Node2D:position"))
  TestFramework.assert_eq anim.track_get_path(0_i64).get_subname_count, 1_i64
  ...
  TestFramework.assert_eq anim.track_get_key_count(0_i64), 3_i64

  # Add animation to library
  anim_lib.add_animation("move_horizontal", anim)
  TestFramework.assert_true anim_lib.has_animation("move_horizontal")

  # Add library to player
  anim_player.add_animation_library("", anim_lib)
  TestFramework.assert_true anim_player.has_animation("move_horizontal")

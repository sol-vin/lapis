...
test_camera "Camera3D projection, FOV, clipping planes & ray unprojection" do
  ...
  TestFramework.assert_eq cam.get_projection, 0_i64
  TestFramework.assert_approx_eq cam.get_fov.to_f32, 75.0_f32
  TestFramework.assert_approx_eq cam.get_near.to_f32, 0.1_f32
  TestFramework.assert_approx_eq cam.get_far.to_f32, 1500.0_f32
  ...
  TestFramework.assert_approx_eq ray_normal.length, 1.0_f32, 0.01
...
test_camera "Camera2D zoom, offset, position smoothing and viewport limits" do
  ...
  TestFramework.assert_approx_eq cam2d.get_zoom.x, 2.5_f32
  TestFramework.assert_approx_eq cam2d.get_zoom.y, 2.5_f32
  TestFramework.assert_approx_eq cam2d.get_offset.x, 100.0_f32
  TestFramework.assert_approx_eq cam2d.get_offset.y, -50.0_f32

  # Limits: Left (0), Top (1), Right (2), Bottom (3)
  cam2d.set_limit(0_i64, -2000_i64)
  cam2d.set_limit(2_i64, 4000_i64)
  TestFramework.assert_eq cam2d.get_limit(0_i64), -2000_i64
  TestFramework.assert_eq cam2d.get_limit(2_i64), 4000_i64
...
test_viewport "SubViewport render target texture, dimensions and update modes" do
  ...
  TestFramework.assert_eq vp.get_size.x, 256
  TestFramework.assert_eq vp.get_size.y, 256
  TestFramework.assert_eq vp.get_update_mode, 2_i64
  TestFramework.assert_eq vp.get_clear_mode, 0_i64

  # Query ViewportTexture
  vp_tex = vp.get_texture
  TestFramework.assert_not_nil vp_tex
  TestFramework.assert_false vp_tex.pointer.null?
  TestFramework.assert_eq vp_tex.get_width, 256_i64
  TestFramework.assert_eq vp_tex.get_height, 256_i64
...
test_viewport "CanvasItem redraw queuing and tree visibility inspection" do
  ...
  TestFramework.assert_true ctrl.is_visible

  ctrl.queue_redraw
  ctrl.set_visible(false)
  TestFramework.assert_false ctrl.is_visible

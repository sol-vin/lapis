...
test_suite "Materials" do
  ...
  assert_approx_eq mat.get_albedo.r, 0.3_f32
  assert_approx_eq mat.get_albedo.g, 0.6_f32
  assert_approx_eq mat.get_albedo.b, 0.9_f32
  assert_approx_eq mat.get_roughness.to_f32, 0.42_f32
  assert_approx_eq mat.get_metallic.to_f32, 0.78_f32
  ...
  assert_eq mat.get_transparency, 1_i64

  mat.set_alpha_scissor_threshold(0.55_f64)
  assert_approx_eq mat.get_alpha_scissor_threshold.to_f32, 0.55_f32

  # Cull mode
  mat.set_cull_mode(Godot::BaseMaterial3D::CullMode::CullDisabled)
  assert_eq mat.get_cull_mode, 2_i64
  ...
  assert_true mat.get_feature(Godot::BaseMaterial3D::Feature::FeatureEmission.value)
  assert_approx_eq mat.get_emission.r, 1.0_f32
  assert_approx_eq mat.get_emission_energy_multiplier.to_f32, 3.5_f32
  ...
  assert_approx_eq orm.get_roughness.to_f32, 0.65_f32
  assert_approx_eq orm.get_metallic.to_f32, 0.35_f32
  ...
  assert_eq cim.get_blend_mode, 2_i64

  cim.set_blend_mode(Godot::CanvasItemMaterial::BlendMode::BlendModeMul)
  assert_eq cim.get_blend_mode, 3_i64
  ...
  assert_eq ppm.get_emission_shape, 1_i64

  ppm.set_emission_sphere_radius(7.5_f64)
  assert_approx_eq ppm.get_emission_sphere_radius.to_f32, 7.5_f32

  # Gravity vector
  ppm.set_gravity(Godot::Vector3.new(0.0, -19.6, 0.0))
  assert_approx_eq ppm.get_gravity.y, -19.6_f32
  ...
  assert_approx_eq ppm.get_param_min(Godot::ParticleProcessMaterial::Parameter::ParamInitialLinearVelocity).to_f32, 15.0_f32
  ...
  assert_not_nil img
  assert_eq img.get_width, 16_i64
  assert_eq img.get_height, 16_i64
  assert_eq img.format, Godot::Image::Format::FormatRgba8
  ...
  assert_approx_eq read_col.r, 0.2_f32, 0.01
  assert_approx_eq read_col.g, 0.7_f32, 0.01
  assert_approx_eq read_col.b, 0.4_f32, 0.01

  # Create ImageTexture from Image using ergonomic factory constructor
  tex = Godot::ImageTexture.create_from_image(img)
  assert_not_nil tex
  assert_eq tex.get_width, 16_i64
  assert_eq tex.get_height, 16_i64

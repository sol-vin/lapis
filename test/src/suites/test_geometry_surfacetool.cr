...
test_geometry "SurfaceTool procedural triangle construction, normal generation and ArrayMesh commit" do
  ...
  TestFramework.assert_eq st.get_primitive_type, Godot::Mesh::PrimitiveType::PrimitiveTriangles.value
  ...
  TestFramework.assert_not_nil mesh
  TestFramework.assert_false mesh.pointer.null?
  TestFramework.assert_eq mesh.get_surface_count, 1_i64
  TestFramework.assert_eq mesh.surface_get_primitive_type(0_i64), Godot::Mesh::PrimitiveType::PrimitiveTriangles.value
...
test_geometry "ArrayMesh surface naming, blend shapes and lifecycle management" do
  ...
  TestFramework.assert_eq Godot::Mesh::ArrayType::ArrayVertex.value, 0_i64
  TestFramework.assert_eq Godot::Mesh::ArrayType::ArrayNormal.value, 1_i64
  TestFramework.assert_eq Godot::Mesh::ArrayType::ArrayColor.value, 3_i64
  TestFramework.assert_eq Godot::Mesh::ArrayType::ArrayIndex.value, 12_i64
  TestFramework.assert_eq Godot::Mesh::ArrayType::ArrayMax.value, 13_i64
  ...
  TestFramework.assert_eq blend_mesh.get_blend_shape_count, 0_i64
  blend_mesh.add_blend_shape("MouthOpen")
  TestFramework.assert_eq blend_mesh.get_blend_shape_count, 1_i64
  blend_mesh.clear_blend_shapes
  TestFramework.assert_eq blend_mesh.get_blend_shape_count, 0_i64

  # Clear surfaces from ArrayMesh
  mesh.clear_surfaces
  TestFramework.assert_eq mesh.get_surface_count, 0_i64
...
test_geometry "ImmediateMesh dynamic surface creation, vertex emission and surface clearing" do
  ...
  TestFramework.assert_eq imm.get_surface_count, 0_i64
  ...
  TestFramework.assert_eq imm.get_surface_count, 1_i64

...
required_assets = [
  ...
  "template/addons/crystal_integration/crystal.gdextension",
  "template/addons/crystal_integration/plugin.cfg",
  "template/addons/crystal_integration/plugin.gd",
  "template/addons/crystal_integration/crystal_icon.svg",
